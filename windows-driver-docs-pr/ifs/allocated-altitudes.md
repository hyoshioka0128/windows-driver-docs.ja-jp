...
現在の高度割り当ては、次のロード順序グループごとに一覧表示されます。

## <a name="span-id420000-429999filterspanspan-id420000-429999filterspanspan-id420000-429999filterspan420000---429999-filter"></a><span id="420000_-_429999__Filter"></span><span id="420000_-_429999__filter"></span><span id="420000_-_429999__FILTER"></span>420000 - 429999:フィルター
...
| AgentComm.sys                 | 401600   | Trustwave 保持しています。        |
...
| aictracedrv\_am.sys              | 388960   | AI のコンサルティング                                          |
| fiopolicyfilter.sys              | 388954   | です                                                |
...
| tsifilemon.sys                   | 388012   | インターコム                                               |
| MarSpy.sys                       | 388010   | インターコム                                               |
...
| TkPcFtCb.sys on 32bit            | 386800   | インカ インターネット co., ltd.                                 |
| TkPcFtCb64.sys on 64bit          | 386800   | インカ インターネット co., ltd.                                 |
...
| WinDBdrv.sys                     | 386520   | NewSoftwares.net,Inc します。                                  |
| WinFLdrv.sys                     | 386510   | NewSoftwares.net,Inc します。                                  |
| WinFPdrv.sys                     | 386500   | NewSoftwares.net,Inc します。                                  |
| SkyAMDrv.sys                     | 386430   | 空の co.                                                |
...
| ISRegFlt.sys                     | 385990   | Flexera ソフトウェア                                       |
| ISRegFlt64.sys                   | 385990   | Flexera ソフトウェア                                       |
...
| Sysmondrv.sys                    | 385201   | マイクロソフト                                              |
| Procmon11.sys                    | 385200   | マイクロソフト                                              |
| minispy.sys - Top                | 385100   | マイクロソフト                                              |
...
| 飛行船 filter.sys               | 383320   | AIRWare Technology Ltd                                 |
...
| DataNow\_ルート              | 383182   | AppSense Ltd                                           |
...
| ntps\_fa.sys                     | 382700   | NTP ソフトウェア                                           |
...
| MCFileMon32.sys (x32 systems)    | 382100   | 三井 Electric ltd.                                 |
...
| PkgFilter.sys                    | 380700   | スケーラブルなソフトウェア                                      |
...
| delete\_flt.sys                  | 370150   | マイクロソフト                                              |
...
| minispy.sys - Middle             | 370000   | マイクロソフト                                              |
...
| cfrmd.sys                        | 368320   | Comodo セキュリティ ソリューション                              |
...
| mfl.sys                          | 367200   | OSR オープン システム リソース, inc.                       |
...
| strapvista.sys (終了バージョン)         | 363700   | AvSoft Technologies                                    |
| SAFE-Agent.sys                   | 363636   | SAFE Cyberdefense                                      |
| EstPrmon.sys                     | 363610   | ESTsoft corp です。                                          |
| Estprp.sys - 64bit               | 363610   | ESTsoft corp です。                                          |
| EstRegmon.sys                    | 363600   | ESTsoft corp です。                                          |
| EstRegp.sys - 64bit              | 363600   | ESTsoft corp です。                                          |
...
| SPIMiniFilter.sys                | 363300   | ソフトウェア Pursuits                                      |
...
| minispy.sys - Bottom             | 361000   | マイクロソフト                                              |
...
| amfsm.sys - Windows XP/2003 x64  | 327600   | パンダ セキュリティ                                            |
...
| 5nine.cbt.sys                    | 327520   | 5 nine ソフトウェア                                            |
| caavFltr.sys                     | 327510   | コンピューター Assoc                                            |
| ino\_fltr.sys                    | 327500   | コンピューター Assoc                                            |
...
| bSyrtp.sys                       | 326230   | BLACKFORT セキュリティ                                        |
...
| tkfsft64.sys - 64bit             | 326110   | インカ インターネット co., Ltd                                    |
...
| EstRkr.sys - 64bit               | 323700   | ESTsoft corp です。                                             |
...
| mDP\_win\_mini.sys      | 302900   | マクロの影響            |
| ctxubs.sys              | 302800   | Citrix システム          |
...
| nvfr\_cpd              | 280310   | Bakbone ソフトウェア      |
| nvfr\_fdd              | 280300   | Bakbone ソフトウェア      |
...
|         SGKD32.SYS          |  267910  |           NetSection セキュリティ            |
...
|        5nine.cbt.sys        |  266100  |              5 nine ソフトウェア              |
...
|    netgateav\_access.sys    |  262910  |           NETGATE 技術。 s.r.o.           |
|     spyemrg\_access.sys     |  262900  |           NETGATE 技術。 s.r.o.           |
...
|     aictracedrv\_cs.sys     |  260500  |              AI のコンサルティング               |
...
| ミニフィルター      | 高度 | Company      |
|-----------------|----------|--------------|
| ntps\_qfs.sys   | 245100   | NTP ソフトウェア |
...
| ntps\_oddm.sys                | 182600   | NTP ソフトウェア                    |
...
| 自動車\_hsmflt.sys               | 182200   | Caringo, Inc.                   |
...
| rbt\_wfd.sys                  | 180300   | Inc、riverbed テクノロジ         |



## <a name="span-id170000-174999fsfilterimagingexzipspanspan-id170000-174999fsfilterimagingexzipspanspan-id170000-174999fsfilterimagingexzipspan170000---174999-fsfilter-imaging-ex-zip"></a><span id="170000_-_174999___FSFilter_Imaging__ex__.ZIP_"></span><span id="170000_-_174999___fsfilter_imaging__ex__.zip_"></span><span id="170000_-_174999___FSFILTER_IMAGING__EX__.ZIP_"></span>170000 - 174999:\*FSFilter イメージング (例: です。ZIP)
...
| 5nine.encryptor.sys         | 145170   | 5 nine ソフトウェア                        |
...
| Tkefsxp.sys - 32bit         | 144500   | インカ インターネット co., Ltd                |
| Tkefsxp64.sys - 64bit       | 144500   | インカ インターネット co., Ltd                |
...
| RRFilterDriverStack\_d3.sys | 142300   | 合理的な保有期間                    |
...
| DataNet\_ルート    | 132100   | AppSense Ltd                  |
...
| cposfw.sys              | 84450    | チェック ポイント ソフトウェア Technologies ltd   |
...
| axfsdrv2.sys           | 62100    | Axence ソフトウェア                         |
| sds.sys                | 62000    | エグレス ソフトウェア                         |
| TotalSystemAuditor.sys | 61600    | ANRC LLC                                |
| MBAMApiary.sys         | 61500    | Malwarebytes corp.                      |
| WA\_FSW.sys            | 61400    | として Administracion y Mejoramiento |
| ViewIntus\_RTAS        | 61300    | Pentego テクノロジ                    |
