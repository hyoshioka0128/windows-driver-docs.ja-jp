---
title: NFC の用語集
description: このトピックでは、NFC クラスの拡張機能 (CX) 用語の用語集を提供します。
...
ms.locfileid: "56572334"
---
# <a name="nfc-glossary"></a>NFC の用語集


このトピックでは、NFC クラスの拡張機能 (CX) 用語の用語集を提供します。
