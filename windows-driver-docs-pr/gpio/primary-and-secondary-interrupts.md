...
ms.locfileid: "56553156"
---
# <a name="primary-and-secondary-interrupts"></a>プライマリとセカンダリの割り込み
...
通常、この 2 つ目の ISR は、GPIO ピンの割り込みをアサート周辺機器のデバイスのドライバーに属しています。 周辺機器のデバイス ドライバを論理的に接続する方法の ISR GPIO 割り込み暗証番号 (pin) については、[GPIO-Based 割り込みリソース](https://msdn.microsoft.com/library/windows/hardware/hh698246)を参照してください。
