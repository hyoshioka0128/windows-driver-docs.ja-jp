---
title: WDF の一般オブジェクトのマクロ
description: このセクションでは、WDF の一般的なオブジェクトをサポートするマクロを説明します。
...
ms.locfileid: "63366484"
---
# <a name="wdf-general-object-macros"></a>WDF の一般オブジェクトのマクロ


このセクションでは、WDF の一般的なオブジェクトをサポートするマクロを説明します。
