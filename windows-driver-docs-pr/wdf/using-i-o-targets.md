...
keywords:
- カーネル モード ドライバー WDK KMDF、I/O のターゲット
- KMDF WDK、I/O のターゲット
- カーネル モード ドライバー フレームワーク WDK、I/O のターゲット
- フレームワーク ベースのドライバー WDK KMDF、I/O のターゲット
- I/O は、WDK KMDF をターゲットします。
- WDK KMDF のターゲット
ms.date: 04/20/2017
...
-   [I/O のターゲットの概要](introduction-to-i-o-targets.md)
-   [一般的な I/O ターゲット](general-i-o-targets.md)
