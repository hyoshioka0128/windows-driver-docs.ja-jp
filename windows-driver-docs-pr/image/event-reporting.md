...
ms.locfileid: "56556795"
---
# <a name="event-reporting"></a>イベントの報告
...
WIA アーキテクチャでは、割り込みのイベントをサポートしているし、イベントをポーリングします。 これらのイベントに関する詳細については、[WIA ドライバー イベント サポート](wia-driver-event-support.md)を参照してください。
