---
title: MediaFrontImageInfo 要素
description: 必要な MediaFrontImageInfo 要素には、シンプレックス スキャンまたは正面 ADF 双方向のスキャンの用のイメージ情報が含まれています。
ms.assetid: 4f1bcc3c-0d5f-490f-8d7a-fc357adeecb4
keywords:
- MediaFrontImageInfo 要素イメージング デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "63379682"
---
# <a name="mediafrontimageinfo-element"></a>MediaFrontImageInfo 要素


必要な**MediaFrontImageInfo**要素にはシンプレックス スキャンまたは正面 ADF 双方向のスキャンの用のイメージ情報が含まれています。
