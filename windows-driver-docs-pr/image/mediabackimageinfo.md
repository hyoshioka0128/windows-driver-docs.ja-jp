---
title: MediaBackImageInfo 要素
description: 省略可能な MediaBackImageInfo 要素には、ADF 双方向のスキャンの背面のイメージ情報が含まれています。
ms.assetid: 42f0151a-6677-41a6-bbf5-0485bd288bb1
keywords:
- MediaBackImageInfo 要素イメージング デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "63380344"
---
# <a name="mediabackimageinfo-element"></a>MediaBackImageInfo 要素


省略可能な**MediaBackImageInfo**要素には、ADF 双方向のスキャンの背面のイメージ情報が含まれています。
