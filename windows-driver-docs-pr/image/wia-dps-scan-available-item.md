...
このプロパティの詳細については、次を参照してください。[スキャンのイベントの入力ソースを識別する](https://docs.microsoft.com/windows-hardware/drivers/image/identifying-the-input-source-for-a-scan-event)します。
