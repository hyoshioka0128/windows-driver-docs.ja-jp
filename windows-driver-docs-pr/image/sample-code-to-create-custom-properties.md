---
title: カスタム プロパティを作成するサンプル コード
description: カスタム プロパティを作成するサンプル コード
...
ms.locfileid: "56536121"
---
# <a name="sample-code-to-create-custom-properties"></a>カスタム プロパティを作成するサンプル コード

カスタム プロパティを作成するには、WIA ドライバーには、次のようなコードがあります。
