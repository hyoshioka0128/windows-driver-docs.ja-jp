---
title: カスタム プロパティの作成のサンプル コード
description: カスタム プロパティの作成のサンプル コード
...
ms.locfileid: "63381563"
---
# <a name="sample-code-to-create-custom-properties"></a>カスタム プロパティの作成のサンプル コード
