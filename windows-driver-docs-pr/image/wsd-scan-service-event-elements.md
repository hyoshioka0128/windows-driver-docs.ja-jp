---
title: WSD スキャン サービス イベント要素
description: WSD スキャン サービス イベント要素
...
ms.locfileid: "63353318"
---
# <a name="wsd-scan-service-event-elements"></a>WSD スキャン サービス イベント要素


このセクションでは、イベントの XML 要素と、Web Services for Devices (WSD) スキャン サービス スキーマを定義するイベントに関連する要素について説明します。

スキーマでは、次のイベントとイベントに関連する要素を定義します。
