---
title: WSD スキャン サービス ジョブとジョブ テーブル要素
description: WSD スキャン サービス ジョブとジョブ テーブル要素
...
ms.locfileid: "63353469"
---
# <a name="wsd-scan-service-job-and-job-table-elements"></a>WSD スキャン サービス ジョブとジョブ テーブル要素


このセクションでは、すべてのジョブと WSD のスキャン サービス スキーマのテーブル要素のジョブについて説明します。
