...
ms.locfileid: "63364552"
---
# <a name="device-settings-configuration-elements"></a>デバイス設定の構成要素


このセクションには、Web Services for Devices (WSD) スキャン サービス スキーマのデバイスの設定要素について説明します。 デバイスの設定では、デバイスのスキャンの基本的な機能について説明します。

スキーマには、次のデバイスの設定要素が含まれています。
