---
title: フィルム要素
description: 省略可能なフィルム要素には、フィルム スキャナーに関連付けられているオプションのスキャンの機能について説明します。
...
ms.locfileid: "56574936"
---
# <a name="film-element"></a>フィルム要素


省略可能な**フィルム**要素が、スキャナーに関連付けられているオプションをスキャンするフィルムの機能について説明します。
