---
title: ADFFront 要素
description: 必要な ADFFront 要素には、スキャナーに関連付けられている自動ドキュメント フィーダー (ADF) の正面の機能について説明します。
ms.assetid: 6b49f5da-6866-4ec6-8973-7c582bd3a1a1
keywords:
- ADFFront 要素イメージング デバイス
topic_type:
- apiref
api_name:
- wscn ADFFront
...
ms.locfileid: "63367084"
---
# <a name="adffront-element"></a>ADFFront 要素


必要な**ADFFront**要素が、スキャナーに関連付けられている自動ドキュメント フィーダー (ADF) の正面の機能について説明します。
...
WSD スキャン サービスの詳細でを指定する必要があります、スキャナー、ADF がある場合、 **ADFFront** ADF の二重化の機能に関係なく、要素。
