---
title: ScannerConfiguration 要素
description: 必要な ScannerConfiguration 要素は、要素のコレクションであり、スキャナーの構成可能な機能について説明します。
ms.assetid: 79c26d0d-ebee-4baf-8689-f5bae088883d
keywords:
- ScannerConfiguration 要素イメージング デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "63370072"
---
# <a name="scannerconfiguration-element"></a>ScannerConfiguration 要素


必要な**ScannerConfiguration**要素は、要素のコレクションであり、スキャナーの構成可能な機能について説明します。
