...
description: WIA\_IPC\_TIMEDELAY プロパティは将来使用するために Microsoft によって予約されてし、は、この時点では実装されていません。
ms.assetid: 3166b2b8-eb90-4474-a9ea-beb752985201
keywords:
- WIA_IPC_TIMEDELAY イメージング デバイス
topic_type:
- apiref
api_name:
- WIA_IPC_TIMEDELAY
...
ms.locfileid: "63378386"
---
# <a name="wiaipctimedelay"></a>WIA\_IPC\_TIMEDELAY


WIA\_IPC\_TIMEDELAY プロパティは将来使用するために Microsoft によって予約されてし、は、この時点では実装されていません。
