---
title: WIA\_DPV\_DSHOW\_デバイス\_パス
description: WIA\_DPV\_DSHOW\_デバイス\_パスのプロパティは将来使用するために Microsoft によって予約されてし、は、この時点では実装されていません。
ms.assetid: 2fdd3f64-0994-49d5-a81c-1c7aa7e40004
keywords:
- WIA_DPV_DSHOW_DEVICE_PATH イメージング デバイス
topic_type:
- apiref
api_name:
...
WIA\_DPV\_DSHOW\_デバイス\_パスのプロパティは将来使用するために Microsoft によって予約されてし、は、この時点では実装されていません。
