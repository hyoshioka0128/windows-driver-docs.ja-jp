---
title: エラー コードをフィルター処理するマクロの例
description: エラー コードをフィルター処理するマクロの例
...
ms.locfileid: "56556781"
---
# <a name="macro-example-to-filter-error-codes"></a>エラー コードをフィルター処理するマクロの例
