---
title: スキャナーの記憶域の必要な WIA 子項目のプロパティ
description: スキャナーの記憶域の必要な WIA 子項目のプロパティ
...
ms.locfileid: "56535731"
---
# <a name="required-wia-child-item-properties-for-scanner-storage"></a>スキャナーの記憶域の必要な WIA 子項目のプロパティ


WIA スキャナー ストレージ (ファイル) の子項目が次の WIA プロパティをサポートするために必要です。
