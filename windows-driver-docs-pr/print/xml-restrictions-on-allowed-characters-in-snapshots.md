---
title: XML のスナップショットで使用できる文字の制限
description: XML のスナップショットで使用できる文字の制限
...
ms.locfileid: "56535637"
---
# <a name="xml-restrictions-on-allowed-characters-in-snapshots"></a>XML のスナップショットで使用できる文字の制限
