...
TVOT\_UDARROW オプションの種類、アップダウン コントロールとグループ ボックス内で、編集コントロールで構成されます。
...
**pOptParam**\[0\]-&gt;**pData**コントロールの単位を識別するテキストの NULL で終わる文字列を指します。

**pOptParam**\[1\]-&gt;**pData**コントロールを記述するテキストの NULL で終わる文字列を指します。 (場合**NULL**、CPSUI ローエンドとハイエンドのコントロールの範囲の値を表示します)。

<span id="IconID"></span><span id="iconid"></span><span id="ICONID"></span>**IconID**  
**pOptParam**\[0\]-&gt;**IconID**トラック バーに関連付けるアイコンを識別します。

**pOptParam**\[1\]-&gt;**IconID**コントロールの範囲の下限を表す 16 ビット符号付きの値を指定します。

<span id="lParam"></span><span id="lparam"></span><span id="LPARAM"></span>**lParam**  
**pOptParam**\[0\]-&gt;**lParam**は使用されません。

**pOptParam**\[1\]-&gt;**lParam**コントロールの範囲の上限を表す 16 ビット符号付きの値を指定します。
