...
TVOT\_UDARROW オプションの型は、アップダウンコントロールと、グループボックス内のエディットコントロールで構成されます。
...
**Poptparam**\[0\]-&gt;**pData**は、コントロールの単位を示す NULL で終わる文字列をポイントします。

**Poptparam**\[1\]-&gt;**pData**は、コントロールを記述する NULL で終わるテキスト文字列をポイントします。 **NULL**の場合、CPSUI は、コントロールの値の範囲の下限と上限を表示します。

<span id="IconID"></span><span id="iconid"></span><span id="ICONID"></span>**IconID**  
**Poptparam**\[0\]-&gt;**IconID**は、トラックバーに関連付けられるアイコンを識別します。

**Poptparam**\[1\]-&gt;**IconID**は、コントロールの範囲の下限を表す16ビット符号付きの値を指定します。

<span id="lParam"></span><span id="lparam"></span><span id="LPARAM"></span>**lParam**  
**Poptparam**\[0\]-&gt;**lParam**は使用されません。

**Poptparam**\[1\]-&gt;**lParam**は、コントロールの範囲の上限を表す16ビット符号付きの値を指定します。
