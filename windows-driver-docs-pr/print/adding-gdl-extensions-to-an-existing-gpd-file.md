---
title: 既存の GPD ファイル GDL 拡張機能の追加
description: 既存の GPD ファイル GDL 拡張機能の追加
...
ms.locfileid: "56550418"
---
# <a name="adding-gdl-extensions-to-an-existing-gpd-file"></a>既存の GPD ファイル GDL 拡張機能の追加
