...
| PrintTicket OtherMetricInviteEnvelope         | GPD ENV\_招待             |
| PrintTicket OtherMetricItalianEnvelope        | GPD ENV\_イタリア              |
| PrintTicket NorthAmericaMonarchEnvelope       | GPD ENV\_MONARCH            |
| PrintTicket NorthAmericaPersonalEnvelope      | GPD ENV\_個人           |
| PrintTicket NorthAmericaESheet                | GPD E シート                  |
| PrintTicket NorthAmericaExecutive             | GPD 大統領               |
| PrintTicket NorthAmericaGermanLegalFanfold    | GPD 複写紙\_された\_ドイツ語    |
| PrintTicket NorthAmericaGermanStandardFanfold | GPD 複写紙\_STD\_ドイツ語    |
| PrintTicket OtherMetricFolio                  | GPD FOLIO                   |
| PrintTicket ISOB4                             | GPD ISO\_B4                 |
| PrintTicket JapanHagakiPostcard               | 日本語の GPD\_はがき      |
...
| PrintTicket NorthAmericaLegal                 | 法的 GPD                   |
| PrintTicket NorthAmericaLegalExtra            | GPD 法務\_追加            |
| PrintTicket NorthAmericaLetter                | GPD 文字                  |
| PrintTicket NorthAmericaLetterExtra           | GPD 文字\_追加           |
| PrintTicket NorthAmericaLetterPlus            | GPD 文字\_PLUS            |
| PrintTicket NorthAmericaNote                  | GPD に注意してください。                    |
...
| PrintTicket NorthAmericaStatement             | GPD ステートメント               |
| PrintTicket NorthAmericaTabloid               | GPD タブロイド                 |
| PrintTicket NorthAmericaTabloidExtra          | GPD タブロイド\_追加          |
