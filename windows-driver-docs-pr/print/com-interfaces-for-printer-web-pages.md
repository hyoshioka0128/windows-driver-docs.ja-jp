---
title: プリンター Web ページの COM インターフェイス
description: プリンター Web ページの COM インターフェイス
MS-HAID:
...
ms.locfileid: "56538346"
---
# <a name="com-interfaces-for-printer-web-pages"></a>プリンター Web ページの COM インターフェイス

Oleprn.dll、によって実装される、次のオートメーション インターフェイスは、プリンター Web ページを作成するための ASP ファイル内で使用できます。

[Iasphelp オートメーション インターフェイス](iasphelp-automation-interface.md)
