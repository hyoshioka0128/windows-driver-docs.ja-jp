...
keywords:
- PrintTicket ドキュメント WDK
- チケットの WDK、PrintTicket ドキュメントを印刷します。
- WDK ドキュメントの説明を印刷します。
- 印刷ジョブ WDK、印刷チケット
- WDK のジョブを印刷する印刷チケット
ms.date: 04/20/2017
...
[Win 32 アプリケーションとの互換性を印刷チケット](print-ticket-compatibility-with-win-32-applications.md)

[印刷チケットの印刷ドライバーの処理](print-ticket-processing-in-the-print-driver.md)

[印刷の Unidrv と PScript5 印刷ドライバーでチケットのサポート](print-ticket-support-in-unidrv-and-pscript5-print-drivers.md)
