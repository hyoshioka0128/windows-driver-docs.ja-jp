---
title: カスタマイズされたオプション
description: カスタマイズされたオプション
ms.assetid: 8b54c59e-b469-488a-ae31-52045c00c971
keywords:
- プリンターは、WDK Unidrv、カスタマイズのオプションします。
- カスタマイズされたプリンターの WDK Unidrv オプションします。
ms.date: 04/20/2017
...
カスタマイズされたオプションの名前は、機能内で一意である必要がありますが、オプション名は、さまざまな機能で再利用できます。 また、カスタマイズされた機能内の標準的なオプション名を使用できます。 したがって、たとえば、名を使用できます、標準オプションは ON、OFF 内でいくつか\*[機能](feature-entry-format.md)カスタマイズされた機能のエントリ。
