---
title: XPSRas GPU 利用デシジョン ツリー
description: 次の図は、Windows を使用して GPU ハードウェア アクセラレーションを連携するかどうかを決定するデシジョン ツリーを示します。
...
次の図は、Windows を使用して GPU ハードウェア アクセラレーションを連携するかどうかを決定するデシジョン ツリーを示します。
