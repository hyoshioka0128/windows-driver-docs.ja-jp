...
ms.locfileid: "56532608"
---
# <a name="color-attributes"></a>色の属性
...
<td><p><strong>TRUE</strong>または<strong>FALSE</strong>します。 示すかどうか、プリンター&#39;副作用なしのドキュメントのページ間の色のモードを変更することができます。</p></td>
<td><p>(省略可能)。 指定されていない場合、既定値は<strong>TRUE</strong>します。 Unidrv は、印刷速度を最適化するために、この値を使用します。 詳細については、次の表の次の注を参照してください。</p></td>
</tr>
<tr class="even">
...
<td><p>(省略可能)。 指定されていない場合は、Unidrv が指定した既定値が使用されます。</p></td>
</tr>
<tr class="odd">
