...
センサー デバイス ドライバーは、Windows ユーザー モード ドライバー フレームワーク (UMDF) を使用して実装されている COM オブジェクトです。 センサー ドライバーは、ヘルパー オブジェクトとして、Windows ポータブル デバイス (WPD) インターフェイスおよびその他の型を使用します。 Windows Driver Kit のドキュメントでは、UMDF と WPD の両方が記載されています。 UMDF ドライバーの詳細については、[ユーザー モード ドライバー フレームワーク](https://msdn.microsoft.com/library/windows/hardware/ff561365)を参照してください。 WPD 種類の詳細については、[ポータブル デバイス](https://msdn.microsoft.com/library/windows/hardware/ff597901)を参照してください。
...
クラスの拡張オブジェクトの詳細については、[センサー クラス拡張について](about-the-sensor-class-extension.md)を参照してください。
