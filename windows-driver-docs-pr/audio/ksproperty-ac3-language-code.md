---
title: KSPROPERTY\_AC3\_言語\_コード
description: KSPROPERTY\_AC3\_言語\_コード プロパティ AC で 3 でエンコードされたストリームの言語コードを指定します。
ms.assetid: 42c0fb44-437c-4fa9-95ee-823880028369
keywords:
- KSPROPERTY_AC3_LANGUAGE_CODE オーディオ デバイス
topic_type:
- apiref
api_name:
...
KSPROPERTY\_AC3\_言語\_コード プロパティ AC で 3 でエンコードされたストリームの言語コードを指定します。
...
プロパティの値 (データの操作) は、KSAC3\_言語\_言語コードを指定するコードの構造体。
