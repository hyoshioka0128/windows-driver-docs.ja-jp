---
title: WDM オーディオ ドライバーからの拡張機能
description: WDM オーディオ ドライバーからの拡張機能
...
ms.locfileid: "56536394"
---
# <a name="extended-capabilities-from-a-wdm-audio-driver"></a>WDM オーディオ ドライバーからの拡張機能
