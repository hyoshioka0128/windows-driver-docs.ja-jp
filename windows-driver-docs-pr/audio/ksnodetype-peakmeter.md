...
Peakmeter ノードは、プロパティのフラグのプロパティ ハンドラーを用意する必要があります (を参照してください[ **KSPROPERTY**](https://msdn.microsoft.com/library/windows/hardware/ff564262))、次の表に表示されます。
