---
title: オーディオの Stream オブジェクト インターフェイス
description: オーディオの Stream オブジェクト インターフェイス
...
ms.locfileid: "56532119"
---
# <a name="audio-stream-object-interfaces"></a>オーディオの Stream オブジェクト インターフェイス
