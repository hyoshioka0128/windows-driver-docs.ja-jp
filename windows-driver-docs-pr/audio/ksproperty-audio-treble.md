---
title: KSK プロパティ\_オーディオ\_高音
description: KSK プロパティ\_AUDIO\_高音ノードのチャネルの高音レベルを指定します (KSNODETYPE\_声調)。
ms.assetid: eee12fac-fbde-44d5-9172-538b9c486697
keywords:
- KSPROPERTY_AUDIO_TREBLE オーディオデバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "72832899"
---
# <a name="ksproperty_audio_treble"></a>KSK プロパティ\_オーディオ\_高音


KSK プロパティ\_AUDIO\_高音ノードのチャネルの高音レベルを指定します ([**KSNODETYPE\_声調**](ksnodetype-tone.md))。
...
プロパティ値 (操作データ) は LONG 型で、チャネルの高音レベルの設定を指定します。 高音レベルの値には、次のスケールが使用されます。
...
フィルターは、フィルターの範囲を超える値を指定するセットプロパティ要求に成功しますが、値はサポートされている範囲にクランプされます。 ただし、このプロパティを取得するための後続の要求では、使用される実際の値が返されます。

### <a name="span-idreturn_valuespanspan-idreturn_valuespanspan-idreturn_valuespanreturn-value"></a><span id="Return_Value"></span><span id="return_value"></span><span id="RETURN_VALUE"></span>戻り値

KSK プロパティ\_AUDIO\_高音プロパティ要求は、正常に完了したことを示すステータス\_成功を返します。 それ以外の場合、要求は適切なエラー状態コードを返します。
