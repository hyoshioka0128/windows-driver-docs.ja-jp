---
title: KSPROPERTY\_SYSAUDIO\_デバイス\_インターフェイス\_名
description: KSPROPERTY\_SYSAUDIO\_デバイス\_インターフェイス\_NAME プロパティが、指定された仮想オーディオ デバイスのプラグ アンド プレイ デバイス インターフェイス名を含む Unicode 文字列を取得します。
ms.assetid: 0541ebb3-ad9a-42c6-9cd6-ea7b056821df
keywords:
- KSPROPERTY_SYSAUDIO_DEVICE_INTERFACE_NAME オーディオ デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "67391605"
---
# <a name="kspropertysysaudiodeviceinterfacename"></a>KSPROPERTY\_SYSAUDIO\_デバイス\_インターフェイス\_名


KSPROPERTY\_SYSAUDIO\_デバイス\_インターフェイス\_NAME プロパティが、指定された仮想オーディオ デバイスのプラグ アンド プレイ デバイス インターフェイス名を含む Unicode 文字列を取得します。
...
プロパティの値 (データの操作) では、デバイスのインターフェイス名を含む Unicode 文字の null で終わる文字列へのポインターです。

### <a name="span-idreturnvaluespanspan-idreturnvaluespanspan-idreturnvaluespanreturn-value"></a><span id="Return_Value"></span><span id="return_value"></span><span id="RETURN_VALUE"></span>戻り値

KSPROPERTY\_SYSAUDIO\_デバイス\_インターフェイス\_プロパティの名前の要求がステータスを返します\_を正常に完了したことを示すために成功します。 それ以外の場合、要求は、適切なエラー状態コードを返します。
