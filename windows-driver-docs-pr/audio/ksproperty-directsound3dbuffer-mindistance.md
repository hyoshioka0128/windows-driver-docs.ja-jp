...
プロパティ値 (データの操作) は FLOAT 型の最小の距離を指定します。 距離単位については、[ **KSPROPERTY\_DIRECTSOUND3DLISTENER\_DISTANCEFACTOR**](ksproperty-directsound3dlistener-distancefactor.md)を参照してください。
