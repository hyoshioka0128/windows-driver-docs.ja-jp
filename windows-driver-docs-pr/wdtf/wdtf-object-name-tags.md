...
description: Wdtf OBJECT_NAME タグは、WDTF オブジェクトログで使用されます。
...
ms.locfileid: "72844791"
---
# <a name="wdtf-object-name-tags"></a>WDTF オブジェクト名のタグ

Wdtf オブジェクト\_NAME タグは、WDTF オブジェクトログで使用されます。
...
## <a name="wdtf-system-actions"></a>WDTF システムアクション
...
## <a name="wdtf-device-actions"></a>WDTF デバイスアクション
...
## <a name="wdtf-device-simple-io-actions"></a>WDTF デバイスの単純な i/o アクション
