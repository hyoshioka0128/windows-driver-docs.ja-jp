---
title: デバイス固有のデータ (_DSD) PCIe ルート ポート
...
ms.locfileid: "56559957"
---
# <a name="acpi-interface-device-specific-data-dsd-for-pcie-root-ports"></a>ACPI インターフェイス:デバイス固有のデータ (_DSD) PCIe ルート ポート
...
## <a name="identifying-pcie-root-ports-supporting-hot-plug-in-d3"></a>D3 のホット プラグをサポートしている PCIe ルート ポートを識別します。
...
## <a name="identifying-externally-exposed-pcie-root-ports"></a>PCIe ルート ポートが公開されている外部を識別します。
