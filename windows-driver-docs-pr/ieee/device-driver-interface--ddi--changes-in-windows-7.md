---
title: Windows 7 でデバイス ドライバー インターフェイス (DDI) の変更
...
ms.locfileid: "56535877"
---
# <a name="device-driver-interface-ddi-changes-in-windows-7"></a>Windows 7 でデバイス ドライバー インターフェイス (DDI) の変更
...
-   [速度とペイロードのサイズの新しいフラグ](#speed)
-   [IEEE 1394 IOCTL を変更します。](#ioctl)
...
<a href="" id="request-async-read"></a>[**要求\_ASYNC\_読み取り**](https://msdn.microsoft.com/library/windows/hardware/ff537634)  
...
<a href="" id="request-isoch-allocate-bandwidth"></a>[**要求\_アイソクロナス\_ALLOCATE\_帯域幅**](https://msdn.microsoft.com/library/windows/hardware/ff537647)  
...
<a href="" id="request-isoch-allocate-resources"></a>[**要求\_アイソクロナス\_ALLOCATE\_リソース**](https://msdn.microsoft.com/library/windows/hardware/ff537649)  
...
<a href="" id="request-isoch-free-bandwidth"></a>[**要求\_アイソクロナス\_FREE\_帯域幅**](https://msdn.microsoft.com/library/windows/hardware/ff537652)  
速度を指定する\_フラグ\_*XXX*のフラグ、 **fulSpeed**メンバー。
...
**注**  新しい 1394 バス ドライバーを使用して、 **fulSpeed**メンバー場合にのみ、IRB\_フラグ\_許可\_リモート\_無料フラグが設定され IRB\_フラグ\_使用\_PRE\_CALCULATE\_値のフラグが設定されていない**フラグ**IRB の。 その他のすべてのケースで新しい 1394 バス ドライバーを無視**fulSpeed**します。

 

<a href="" id="request-set-device-xmit-properties"></a>[**要求\_設定\_デバイス\_XMIT\_プロパティ**](https://msdn.microsoft.com/library/windows/hardware/ff537662)  
速度を指定する\_フラグ\_*XXX*のフラグ、 **fulSpeed**メンバー。
...
<a href="" id="request-async-stream"></a>[**要求\_ASYNC\_ストリーム**](https://msdn.microsoft.com/library/windows/hardware/ff537635)  
...
<a href="" id="request-isoch-modify-stream-properties"></a>要求\_アイソクロナス\_変更\_ストリーム\_プロパティ  
速度を指定する\_フラグ\_*XXX*のフラグ、 **fulSpeed**メンバー。
...
<a href="" id="request-get-speed-between-devices"></a>[**要求\_取得\_速度\_BETWEEN\_デバイス**](https://msdn.microsoft.com/library/windows/hardware/ff537645)  
速度を指定する\_フラグ\_*XXX*のフラグ、 **fulSpeed**メンバー。
...
**注**  クライアント ドライバーでは、使用を指定できますも\_SCODE\_速度フラグ**u.GetMaxSpeedBetweenDevices.fulFlags**を要求できる SCODE\_ *XXX*\_レート速度コード値で返す**fulSpeed**速度ではなく\_フラグ\_xxx の値。
