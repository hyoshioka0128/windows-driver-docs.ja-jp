---
title: ネットワークカメラの設計ガイド
description: ネットワークカメラコントロールとプロパティセットについて説明します。
ms.date: 04/14/2020
...
ms.locfileid: "83270409"
---
# <a name="network-camera-design-guide"></a>ネットワークカメラの設計ガイド

ネットワークカメラの設計ガイドでは、次のコントロール、プロパティセット、および DDIs について説明します。
