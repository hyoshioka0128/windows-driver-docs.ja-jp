---
title: KSEVENT\_チューナー\_CHANGED
description: KSEVENT\_チューナー\_CHANGED イベントがユーザー モードで DirectShow をカーネル モードのビデオ キャプチャ ミニドライバーから、チャネルの変更などのアクションを伝達します。
ms.assetid: 7286e36c-a433-40a0-9281-7eac4ab64cbf
keywords:
- KSEVENT_TUNER_CHANGED ストリーミング メディア デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "63368730"
---
# <a name="kseventtunerchanged"></a>KSEVENT\_チューナー\_CHANGED


KSEVENT\_チューナー\_CHANGED イベントがユーザー モードで DirectShow をカーネル モードのビデオ キャプチャ ミニドライバーから、チャネルの変更などのアクションを伝達します。
