---
title: KSEVENT\_TVAUDIO\_変更されました
description: KSEVENT\_TVAUDIO\_CHANGED イベントは、新たにチューニングされたチャネルなどのアクションを、カーネルモードのビデオキャプチャミニドライバーからユーザーモードの DirectShow にまで伝達します。
ms.assetid: 98d77001-9844-4893-9a23-9c06f7d75841
keywords:
- KSEVENT_TVAUDIO_CHANGED ストリーミングメディアデバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "72843677"
---
# <a name="ksevent_tvaudio_changed"></a>KSEVENT\_TVAUDIO\_変更されました


KSEVENT\_TVAUDIO\_CHANGED イベントは、新たにチューニングされたチャネルなどのアクションを、カーネルモードのビデオキャプチャミニドライバーからユーザーモードの DirectShow にまで伝達します。
