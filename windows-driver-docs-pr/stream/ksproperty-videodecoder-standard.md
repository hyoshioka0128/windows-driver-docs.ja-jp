---
title: KSK プロパティ\_VIDEODECODER\_STANDARD
description: KSK プロパティ\_VIDEODECODER\_標準プロパティは、現在のアナログビデオ標準を制御します。 このプロパティを実装する必要があります。
ms.assetid: 955c267a-703e-4d18-a4e9-710f316cfb48
keywords:
- KSPROPERTY_VIDEODECODER_STANDARD ストリーミングメディアデバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "72845062"
---
# <a name="ksproperty_videodecoder_standard"></a>KSK プロパティ\_VIDEODECODER\_STANDARD


KSK プロパティ\_VIDEODECODER\_標準プロパティは、現在のアナログビデオ標準を制御します。 このプロパティを実装する必要があります。
...
プロパティ値 (操作データ) は、現在のアナログビデオ標準を指定する ULONG です。

<a name="remarks"></a>注釈
-------

\_VIDEODECODER\_S 構造体の**値**メンバーは、現在のアナログビデオ標準を指定します。
