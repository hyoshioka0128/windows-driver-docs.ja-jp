---
title: ビデオ圧縮のプロパティ
description: ビデオ圧縮のプロパティ
ms.assetid: 2fd69425-7c36-4766-88e6-7f02d5fa6659
keywords:
- ビデオの圧縮プロパティ WDK ビデオのキャプチャします。
- 圧縮プロパティ WDK ビデオのキャプチャします。
...
ms.locfileid: "63360460"
---
# <a name="video-compression-properties"></a>ビデオ圧縮のプロパティ


[PROPSETID\_しました\_VIDEOCOMPRESSION](https://msdn.microsoft.com/library/windows/hardware/ff567813)ビデオの圧縮に関連するプロパティがプロパティ セットに含まれています。 次の表に、プロパティ、PROPSETID の一部である\_しました\_VIDEOCOMPRESSION プロパティ セット。
...
<thead>
<tr class="header">
<th>PROPSETID_VIDCAP_VIDEOCOMPRESSION KS プロパティ</th>
<th>プロパティの説明</th>
</tr>
</thead>
<tbody>
...
<td><p>デバイスのビデオの圧縮機能に関する情報を返します。</p></td>
</tr>
<tr class="even">
...
<td><p>ビデオの圧縮のキーフレームのレートを制御します。</p></td>
</tr>
<tr class="odd">
...
<td><p>現在のサイズをオーバーライドする一時的な新しいフレーム サイズを指定します。</p></td>
</tr>
<tr class="even">
...
<td><p>現在のレートを上書きする一時的な新しいキーフレーム レートを指定します。</p></td>
</tr>
<tr class="odd">
...
<td><p>平均のビデオ フレームのデータ速度を制御します。</p></td>
</tr>
</tbody>
</table>
