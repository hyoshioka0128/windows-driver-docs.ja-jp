---
title: KSEVENT\_クロスバー\_CHANGED
description: KSEVENT\_クロスバー\_CHANGED イベントがユーザー モードで DirectShow をカーネル モードのビデオ キャプチャ ミニドライバーから、新しいルーティングの構成などのアクションを伝達します。
ms.assetid: b67d95a3-7c30-49ae-a2df-eb88491c2e97
keywords:
- KSEVENT_CROSSBAR_CHANGED ストリーミング メディア デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "56571273"
---
# <a name="kseventcrossbarchanged"></a>KSEVENT\_クロスバー\_CHANGED


KSEVENT\_クロスバー\_CHANGED イベントがユーザー モードで DirectShow をカーネル モードのビデオ キャプチャ ミニドライバーから、新しいルーティングの構成などのアクションを伝達します。
