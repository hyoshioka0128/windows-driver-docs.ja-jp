---
title: KSPROPERTY\_EXTXPORT\_ATN\_検索
description: KSPROPERTY\_EXTXPORT\_ATN\_検索プロパティは、テープ上の絶対の特定のトラック数 (ATN) を検索します。
ms.assetid: e5bc7552-64a8-4567-9dc3-3f2b50411cc6
keywords:
- KSPROPERTY_EXTXPORT_ATN_SEARCH ストリーミング メディア デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "67354859"
---
# <a name="kspropertyextxportatnsearch"></a>KSPROPERTY\_EXTXPORT\_ATN\_検索


KSPROPERTY\_EXTXPORT\_ATN\_検索プロパティは、テープ上の絶対の特定のトラック数 (ATN) を検索します。
...
プロパティの値 (データの操作) は、絶対のトラック数を指定する DWORD です。

<a name="remarks"></a>注釈
-------

**DwAbsTrackNumber** 、KSPROPERTY のメンバー\_EXTXPORT\_の構造を検索する絶対追跡番号を指定します。
