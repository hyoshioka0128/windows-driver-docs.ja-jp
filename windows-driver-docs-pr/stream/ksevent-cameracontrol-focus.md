---
title: KSEVENT\_CAMERACONTROL\_フォーカス
description: KSEVENT\_CAMERACONTROL\_カメラ フォーカスの操作が完了または取り消されたフォーカス イベントがトリガーされます。
ms.assetid: 7B10D45F-4673-405C-B44F-3FAA3E8957EF
keywords:
- KSEVENT_CAMERACONTROL_FOCUS ストリーミング メディア デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "56557923"
---
# <a name="kseventcameracontrolfocus"></a>KSEVENT\_CAMERACONTROL\_フォーカス


**KSEVENT\_CAMERACONTROL\_フォーカス**カメラ フォーカスの操作が完了または取り消されたイベントがトリガーされます。
