---
title: TV オーディオのプロパティ
description: TV オーディオのプロパティ
ms.assetid: 0eed4007-9fd9-4927-8ac7-2e23fd082dec
keywords:
- テレビのオーディオ プロパティ WDK ビデオのキャプチャします。
- WDK のビデオのオーディオのプロパティをキャプチャします。
...
ms.locfileid: "63382502"
---
# <a name="tv-audio-properties"></a>TV オーディオのプロパティ


[PROPSETID\_しました\_TVAUDIO](https://msdn.microsoft.com/library/windows/hardware/ff567811)テレビ オーディオに関連するプロパティがプロパティ セットに含まれています。 次の表に、プロパティ、PROPSETID の一部である\_しました\_TVAUDIO プロパティ セット。
...
<thead>
<tr class="header">
<th>PROPSETID_VIDCAP_TVAUDIO KS プロパティ</th>
<th>プロパティの説明</th>
</tr>
</thead>
<tbody>
...
<td><p>テレビのオーディオ デバイス、ハードウェアが mono またはステレオ オーディオと SAP をサポートしているかどうかなどの機能に関する情報を返します。</p></td>
</tr>
<tr class="even">
...
<td><p>プロパティの照会時に現在使用可能なテレビ オーディオ モードを返します。</p></td>
</tr>
<tr class="odd">
...
<td><p>テレビのオーディオ デバイスの現在のオーディオ モードを制御します。</p></td>
</tr>
</tbody>
</table>
