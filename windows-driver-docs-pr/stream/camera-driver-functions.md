---
title: Windows 10 用の新しいカメラ ドライバー機能
description: 次のカメラドライバー関数は、Windows 10 用の新機能です。
ms.assetid: 42116C2B-BEB8-4A8C-99AC-0D0B2E7B124C
ms.date: 04/20/2017
ms.localizationpriority: medium
ms.openlocfilehash: a861a16e7e085fbde58c9254b85463b8600a1b91
ms.sourcegitcommit: 4b7a6ac7c68e6ad6f27da5d1dc4deabd5d34b748
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 10/24/2019
ms.locfileid: "72844743"
---
# <a name="new-camera-driver-functions-for-windows-10"></a>Windows 10 用の新しいカメラ ドライバー機能


次のカメラドライバー関数は、Windows 10 用の新機能です。
...
[**Ksk Generateの悪意のあるイベント**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ks/nf-ks-ksgeneratethermalevent)
