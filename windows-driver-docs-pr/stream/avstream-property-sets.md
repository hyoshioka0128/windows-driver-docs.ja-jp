---
title: AVStream のプロパティ セット
description: AVStream のプロパティ セット
...
ms.locfileid: "56571822"
---
# <a name="avstream-property-sets"></a>AVStream のプロパティ セット


## <span id="ddk_kernel_streaming_property_sets_ks"></span><span id="DDK_KERNEL_STREAMING_PROPERTY_SETS_KS"></span>


このセクションでは、次の AVStream プロパティ セットを説明します。

[KSPROPSETID\_クロック](kspropsetid-clock.md)

[KSPROPSETID\_接続](kspropsetid-connection.md)

[KSPROPSETID\_全般](kspropsetid-general.md)

[KSPROPSETID\_GM](kspropsetid-gm.md)

[KSPROPSETID\_MediaSeeking](kspropsetid-mediaseeking.md)

[KSPROPSETID\_暗証番号 (pin)](kspropsetid-pin.md)

[KSPROPSETID\_品質](kspropsetid-quality.md)
...
[KSPROPSETID\_トポロジ](kspropsetid-topology.md)

[KSPROPSETID\_VramCapture](kspropsetid-vramcapture.md)

ドライバーの種類を作成する方法に関するドキュメントについては特定のデバイスの種類であるプロパティを設定します。
