...
description: KSPROPERTY\_MEDIASEEKING\_TIMEFORMAT プロパティ フィルターの現在のメディア時間形式を取得します。
ms.assetid: 3a7b6873-7351-4e87-8fa7-a804894c56bb
keywords:
- KSPROPERTY_MEDIASEEKING_TIMEFORMAT ストリーミング メディア デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "63346487"
---
# <a name="kspropertymediaseekingtimeformat"></a>KSPROPERTY\_MEDIASEEKING\_TIMEFORMAT


KSPROPERTY\_MEDIASEEKING\_TIMEFORMAT プロパティ フィルターの現在のメディア時間形式を取得します。
...
プロパティは、時刻形式の GUID として返される現在のメディア時間形式を設定します。
