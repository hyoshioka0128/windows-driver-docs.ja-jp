...
KSMETHODSETID\_StreamAllocator メソッドのセットが、アロケーターの IRP に基づくインターフェイスの関数を指定します。

このメソッドのセットが含まれます。

[**KSMETHOD\_STREAMALLOCATOR\_アロケーション**](ksmethod-streamallocator-alloc.md)
