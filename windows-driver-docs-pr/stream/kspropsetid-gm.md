...
プロパティ、KSPROPSETID\_GM プロパティの設定は、KSPROPERTY で列挙\_GM。

このセクションでは、次のトピックについて説明します。

[**KSPROPERTY\_GM\_GRAPHMANAGER**](ksproperty-gm-graphmanager.md)

[**KSPROPERTY\_GM\_タイムスタンプ\_クロック**](ksproperty-gm-timestamp-clock.md)

[**KSPROPERTY\_GM\_RATEMATCH**](ksproperty-gm-ratematch.md)

[**KSPROPERTY\_GM\_レンダリング\_クロック**](ksproperty-gm-render-clock.md)
