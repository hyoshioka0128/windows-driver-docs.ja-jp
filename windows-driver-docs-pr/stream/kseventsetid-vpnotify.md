...
**KSEVENTSETID\_VPNotify**ビデオ ポートのピクセル形式の変更などのビデオ ポート イベントが発生したときにクライアントに通知するイベントのセットを使用します。

このセット内のイベントの項目が、KSEVENT で指定された\_VPNOTIFY 列挙体。

このセット内の唯一のイベントは[ **KSEVENT\_VPNOTIFY\_段落**](ksevent-vpnotify-formatchange.md)します。
