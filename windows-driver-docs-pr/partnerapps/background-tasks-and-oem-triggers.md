...
詳細なガイダンスについて、作成、構成、およびバック グラウンド タスクとトリガーを使用するを参照してください[クイック スタート。作成し、バック グラウンド タスクを登録](https://docs.microsoft.com/previous-versions/windows/apps/hh977055(v=win.10))します。
