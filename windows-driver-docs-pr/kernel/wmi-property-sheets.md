...
ドライバーで特定のコントロールを有効にできる、**電源管理**のタブ、**デバイス マネージャー**特定特定の WMI クラスの Guid をサポートすることで、プロパティ シートです。 参照してください[WMI および電源管理 タブに](wmi-and-the-power-management-tab.md)詳細についてはします。
