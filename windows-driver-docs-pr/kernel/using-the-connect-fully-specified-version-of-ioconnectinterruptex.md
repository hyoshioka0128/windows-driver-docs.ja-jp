---
title: IoConnectInterruptEx の CONNECT_FULLY_SPECIFIED バージョンを使用してください。
description: IoConnectInterruptEx の CONNECT_FULLY_SPECIFIED バージョンを使用してください。
