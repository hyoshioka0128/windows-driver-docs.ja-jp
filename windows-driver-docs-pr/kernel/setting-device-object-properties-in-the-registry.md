...
-   非 WDM ドライバーでは、名前付きのデバイス オブジェクトのデバイス セットアップ クラスのプロパティを設定できます。 デバイス オブジェクトを作成するときに、ドライバーはデバイス セットアップ クラスを指定します**IoCreateDeviceSecure**します。 デバイス セットアップ クラスを指定する方法の詳細については、[ **IoCreateDeviceSecure**](https://msdn.microsoft.com/library/windows/hardware/ff548407)を参照してください。
