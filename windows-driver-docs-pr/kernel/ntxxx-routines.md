...
ms.locfileid: "56536776"
---
# <a name="ntxxx-routines"></a>NtXxx ルーチン


このセクションについて説明します、 **Nt * Xxx*** バージョンの Windows のネイティブ システム サービス ルーチン。 ほとんどのネイティブ システム サービス ルーチンがある 2 つのバージョン、1 つに名前が、プレフィックスで始まる**Nt**; その他のバージョンが、プレフィックスで始まる名前**Zw**します。 たとえば、呼び出し[ **NtCreateFile** ](https://msdn.microsoft.com/library/windows/hardware/ff556465)と[ **ZwCreateFile** ](https://msdn.microsoft.com/library/windows/hardware/ff566424)同様の操作を実行し、同じサービスが、実際には、カーネル モード システム ルーチンです。
