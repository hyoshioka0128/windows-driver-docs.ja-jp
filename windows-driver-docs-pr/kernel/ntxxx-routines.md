...
ms.locfileid: "72827819"
---
# <a name="ntxxx-routines"></a>NtXxx ルーチン


このセクションでは、Windows ネイティブシステムサービスルーチンの**Nt * Xxx*** バージョンについて説明します。 ほとんどのネイティブシステムサービスルーチンには2つのバージョンがあり、そのうちの1つにはプレフィックス**Nt**で始まる名前が付いています。もう1つのバージョンには、 **Zw**というプレフィックスで始まる名前が付いています。 たとえば、 [**Ntcreatefile**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntcreatefile)と[**zwcreatefile**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntcreatefile)を呼び出すと、同様の操作が実行され、実際には同じカーネルモードシステムルーチンによって処理されます。

カーネルモードドライバーからの呼び出しの場合、Windows ネイティブシステムサービスルーチンの**Nt * xxx*** バージョンと**Zw * xxx*** バージョンの動作は、入力パラメーターの処理方法と解釈方法によって異なる場合があります。 **Nt * xxx*** バージョンと**Zw * xxx*** バージョンのルーチンの関係の詳細については、「 [Using nt And Zw Version Of the Native System Services ルーチン](using-nt-and-zw-versions-of-the-native-system-services-routines.md)」を参照してください。

次の表は、 **Nt * xxx*** と**Zw * xxx*** バージョンのルーチンの概要を示しています。
...
<tbody>
<tr class="odd">
<td><p>Ntallocatelocuniqueid</p></td>
...
<tr class="odd">
<td><p>NtCommitEnlistment リスト</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntcommitenlistment" data-raw-source="[&lt;strong&gt;ZwCommitEnlistment&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntcommitenlistment)"><strong>ZwCommitEnlistment リスト</strong></a></p></td>
</tr>
<tr class="even">
...
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntcreateenlistment" data-raw-source="[&lt;strong&gt;ZwCreateEnlistment&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntcreateenlistment)"><strong>ZwCreateEnlistment リスト</strong></a></p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p>Ntています</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-zwcreatesection" data-raw-source="[&lt;strong&gt;ZwCreateSection&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-zwcreatesection)"><strong>Zw/</strong></a></p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><p>Ntmake一時オブジェクト</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-zwmaketemporaryobject" data-raw-source="[&lt;strong&gt;ZwMakeTemporaryObject&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-zwmaketemporaryobject)"><strong>Zwmake一時オブジェクト</strong></a></p></td>
</tr>
<tr class="odd">
...
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntopenenlistment" data-raw-source="[&lt;strong&gt;ZwOpenEnlistment&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntopenenlistment)"><strong>ZwOpenEnlistment リスト</strong></a></p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p>Ntの完了</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntpreparecomplete" data-raw-source="[&lt;strong&gt;ZwPrepareComplete&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntpreparecomplete)"><strong>Zw分離完了</strong></a></p></td>
</tr>
<tr class="even">
<td><p>Ntの登録</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntprepareenlistment" data-raw-source="[&lt;strong&gt;ZwPrepareEnlistment&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntprepareenlistment)"><strong>Zw/参加リスト</strong></a></p></td>
</tr>
<tr class="odd">
<td><p>Ntpreの完了</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntprepreparecomplete" data-raw-source="[&lt;strong&gt;ZwPrePrepareComplete&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntprepreparecomplete)"><strong>Zwpreプロビジョニング完了</strong></a></p></td>
</tr>
<tr class="even">
<td><p>Ntpre/参加リスト</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntpreprepareenlistment" data-raw-source="[&lt;strong&gt;ZwPrePrepareEnlistment&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntpreprepareenlistment)"><strong>Zwpre/登録</strong></a></p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><p>Ntqueryfull属性ファイル</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-zwqueryfullattributesfile" data-raw-source="[&lt;strong&gt;ZwQueryFullAttributesFile&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-zwqueryfullattributesfile)"><strong>Zwqueryfull属性ファイル</strong></a></p></td>
</tr>
<tr class="odd">
<td><p>NtQueryInformationEnlistment リスト</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntqueryinformationenlistment" data-raw-source="[&lt;strong&gt;ZwQueryInformationEnlistment&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntqueryinformationenlistment)"><strong>ZwQueryInformationEnlistment リスト</strong></a></p></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><p>NtReadOnlyEnlistment</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntrecoverenlistment" data-raw-source="[&lt;strong&gt;ZwRecoverEnlistment&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntrecoverenlistment)"><strong>Zw回復参加リスト</strong></a></p></td>
</tr>
<tr class="even">
<td><p>Nt回復マネージャー</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntrecoverresourcemanager" data-raw-source="[&lt;strong&gt;ZwRecoverResourceManager&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntrecoverresourcemanager)"><strong>Zw回復マネージャー</strong></a></p></td>
</tr>
<tr class="odd">
<td><p>Nt回復の Transactionmanager</p></td>
<td><p><a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntrecovertransactionmanager" data-raw-source="[&lt;strong&gt;ZwRecoverTransactionManager&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntrecovertransactionmanager)"><strong>Zw回復した Transactionmanager</strong></a></p></td>
</tr>
<tr class="even">
