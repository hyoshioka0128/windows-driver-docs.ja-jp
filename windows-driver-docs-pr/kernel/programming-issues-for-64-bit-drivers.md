...
keywords:
- 64 ビットの WDK カーネル
- カーネル モード ドライバー WDK、64 ビットの問題
- WDK の 64 ビットの Win32 アプリケーション
- ユーザー モード アプリケーション WDK 64 ビット
ms.date: 06/16/2017
...
このセクションでは、64 ビット処理環境用のドライバーを開発する際に考慮する必要がある問題について説明します。 次のセクションが含まれています。

[64 ビット Windows は、ドライバーの移植](porting-your-driver-to-64-bit-windows.md)
