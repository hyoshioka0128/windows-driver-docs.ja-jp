---
title: ダイレクト I/O を使用して DispatchReadWrite
description: ダイレクト I/O を使用して DispatchReadWrite
...
ms.locfileid: "56529546"
---
# <a name="dispatchreadwrite-using-direct-io"></a>ダイレクト I/O を使用して DispatchReadWrite
