...
|0x00000000&#160;00000010 |コント ローラーのサポート、公開の有効性を確認する X 座標と Y 座標曲線の中にセキュリティで保護されたシンプル P-192 および P-256 のペアリング プロセス。 <p>詳細については、次を参照してください。 [Bluetooth のコア仕様 Erratum 10734](https://www.bluetooth.org/docman/handlers/downloaddoc.ashx?doc_id=447440)します。</p>|
