...
ms.locfileid: "63328342"
---
# <a name="appendix-a-how-to-install-an-in-box-bluetooth-driver-on-new-hardware-in-windows-vista"></a>付録 A:Windows Vista の新しいハードウェアにインボックス Bluetooth ドライバーをインストールする方法
