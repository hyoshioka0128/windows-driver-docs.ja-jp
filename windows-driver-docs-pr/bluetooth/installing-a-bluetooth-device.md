---
title: Bluetooth デバイスをインストールします。
description: Bluetooth デバイスをインストールします。
...
ms.locfileid: "56539437"
---
# <a name="installing-a-bluetooth-device"></a>Bluetooth デバイスをインストールします。
