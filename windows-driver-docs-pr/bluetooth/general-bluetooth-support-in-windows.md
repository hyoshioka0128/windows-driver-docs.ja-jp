...
### <a name="windows-10-for-desktop-editions-in-box-bluetooth-profiles"></a>Windows 10 のデスクトップ エディションのボックスで Bluetooth のプロファイル:
...
**Windows 10 Mobile のボックスで Bluetooth のプロファイル:**
