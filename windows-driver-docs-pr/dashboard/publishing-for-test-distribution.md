...
## <a name="span-idclient_pc_configurationspanspan-idclient_pc_configurationspanspan-idclient_pc_configurationspanclient-pc-configuration"></a><span id="Client_PC_configuration"></span><span id="client_pc_configuration"></span><span id="CLIENT_PC_CONFIGURATION"></span>クライアント PC の構成
