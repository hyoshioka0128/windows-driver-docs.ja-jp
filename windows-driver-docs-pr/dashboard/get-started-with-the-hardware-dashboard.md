...
ms.locfileid: "57560597"
---
# <a name="get-started-with-the-hardware-dashboard-program"></a>ハードウェア ダッシュボード プログラムの概要

パートナー センターを使用すると、迅速かつ容易にシステムおよびドライバーの申請を作成して管理することができ、次のようなエクスペリエンスが向上します。
...
## <a name="design-create-and-test-your-hardware-and-drivers"></a>ハードウェアとドライバーの設計、作成、テスト
...
これらのプログラムでは、事前にハードウェアとドライバーを設計、作成、テストしたうえで、最終バージョンをパートナー センターで提出できます。 詳しくは、「[Windows ハードウェア認定](https://go.microsoft.com/fwlink/p/?LinkId=224782)」ページをご覧ください。

## <a name="submit-your-hardware-and-drivers-for-the-compatibility-program-or-certification"></a>互換性プログラムまたは認定のためのハードウェアとドライバーの提出
