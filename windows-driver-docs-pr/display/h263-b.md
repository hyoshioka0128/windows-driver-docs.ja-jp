...
に対して次の制限、 [ **DXVA\_ConnectMode** ](https://msdn.microsoft.com/library/windows/hardware/ff563138)構造体に適用されるときに、 *bDXVA\_Func* で定義された変数**dwFunction**のメンバー [ **DXVA\_ConfigPictureDecode** ](https://msdn.microsoft.com/library/windows/hardware/ff563133)が 1 (画像をデコード)。
...
次の制限、 [ **DXVA\_PictureParameters** ](https://msdn.microsoft.com/library/windows/hardware/ff564012)構造体は、ときに適用、 [bDXVA\_Func 変数](bdxva-func-variable.md)で定義されている、**dwFunction**のメンバー [ **DXVA\_ConfigPictureDecode** ](https://msdn.microsoft.com/library/windows/hardware/ff563133)が 1 にします。
