...
場合、 **bPicOBMC**のメンバー [ **DXVA\_PictureParameters** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/dxva/ns-dxva-_dxva_pictureparameters) 1 は、および*Motion4MV* で定義された変数**wMBtype**マクロ ブロックのこれらのコントロール構造体のメンバーは、1、 *MotionBackward*変数で定義されている、 **wMBtype**メンバーは 0 である必要があります。
