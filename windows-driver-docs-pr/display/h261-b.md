...
次の制限、 [ **DXVA\_PictureParameters** ](https://msdn.microsoft.com/library/windows/hardware/ff564012)構造体は、ときに適用、 [bDXVA\_Func 変数](bdxva-func-variable.md)によって定義された、**dwFunction**のメンバー [ **DXVA\_ConfigPictureDecode** ](https://msdn.microsoft.com/library/windows/hardware/ff563133)が 1 にします。
