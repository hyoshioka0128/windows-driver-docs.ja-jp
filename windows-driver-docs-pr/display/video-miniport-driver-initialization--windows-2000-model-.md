---
title: ビデオのミニポート ドライバーの初期化 (Windows 2000 モデル)
description: ビデオのミニポート ドライバーの初期化 (Windows 2000 モデル)
...
ms.locfileid: "56556779"
---
# <a name="video-miniport-driver-initialization-windows-2000-model"></a>ビデオのミニポート ドライバーの初期化 (Windows 2000 モデル)
