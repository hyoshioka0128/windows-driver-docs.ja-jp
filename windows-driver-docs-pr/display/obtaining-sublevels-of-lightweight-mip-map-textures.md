---
title: 軽量の MIP マップ テクスチャの下位レベルの取得
description: 軽量の MIP マップ テクスチャの下位レベルの取得
...
ms.locfileid: "56539405"
---
# <a name="obtaining-sublevels-of-lightweight-mip-map-textures"></a>軽量の MIP マップ テクスチャの下位レベルの取得
