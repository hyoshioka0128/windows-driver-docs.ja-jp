---
title: D3DKMT\_MULTIPLANE\_オーバーレイ\_YCbCr\_フラグ列挙体
description: システムの使用に予約されています。 ドライバーでは使用しないでください。
ms.assetid: 3bfcd424-961f-4efe-a928-2ee7fbd29f4a
keywords:
- D3DKMT_MULTIPLANE_OVERLAY_YCbCr_FLAGS 列挙ディスプレイ デバイス
topic_type:
- apiref
api_name:
...
ms.locfileid: "63391253"
---
# <a name="d3dkmtmultiplaneoverlayycbcrflags-enumeration"></a>D3DKMT\_MULTIPLANE\_オーバーレイ\_YCbCr\_フラグ列挙体
