...
プロセスは、すべての描画状態、または他の種類の命令も同じです。 場合、 **bCommand**のメンバー、 [ **D3DHAL\_DP2COMMAND** ](https://msdn.microsoft.com/library/windows/hardware/ff545454)構造体が D3DDP2OP\_RENDERSTATE、その構造に従うは、 [**D3DHAL\_DP2RENDERSTATE** ](https://msdn.microsoft.com/library/windows/hardware/ff545705)構造とその構造体の情報は、レンダリング状態を適宜設定に使用されます。
