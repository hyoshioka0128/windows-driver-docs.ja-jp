---
title: Direct3D のバージョン 10.1 のバージョン番号
description: Direct3D のバージョン 10.1 のバージョン番号
...
ms.locfileid: "56528231"
---
# <a name="version-numbers-for-direct3d-version-101"></a>Direct3D のバージョン 10.1 のバージョン番号
