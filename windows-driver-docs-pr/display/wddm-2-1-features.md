...
ドライバーは、 [DXGK_DRIVERCAPS:: WDDMVersion](https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/d3dkmddi/ns-d3dkmddi-_dxgk_drivercaps)を使用して WDDM 2.1 サポートを新しいバージョン定数で報告します。
...
* Windows 7 WDDM 1.1:
    ...
    * FL_10_0 ドライバーの D3D11 DDI では、8.16.0000.0000 を8.16.9999.9999 に使用できます。
    * FL_11_0 ドライバーの D3D11 DDI では、8.17.0000.0000 を8.17.9999.9999 に使用できます。

* Windows 8 WDDM 1.2:

    * FL_10_0 HW は9.15.0000.0000 に9.15.9999.9999 を使用できます。
    * FL_10_1 HW は9.16.0000.0000 に9.16.9999.9999 を使用できます。
    * FL_11_0 HW は9.17.0000.0000 に9.17.9999.9999 を使用できます。
    * FL_11_1 HW は9.18.0000.0000 に9.18.9999.9999 を使用できます。

* Windows 8.1 WDDM 1.3:

    * FL_10_0 HW は10.15.0000.0000 に10.15.9999.9999 を使用できます。
    * FL_10_1 HW は10.16.0000.0000 に10.16.9999.9999 を使用できます。
    * FL_11_0 HW は10.17.0000.0000 に10.17.9999.9999 を使用できます。
    * FL_11_1 HW は10.18.0000.0000 に10.18.9999.9999 を使用できます。

* Windows 10 WDDM 2.0:

    * FL_11_1 HW は20.18.0000.0000 に20.18.65535.65535 を使用できます。
    * FL_12_0 HW は20.19.0000.0000 に20.19.65535.65535 を使用できます。
    * FL_12_1 HW は20.20.0000.0000 に20.20.65535.65535 を使用できます。

* Windows 10 WDDM 2.1:

    * FL_11_1 HW は20.18.0000.0000 に21.18.65535.65535 を使用できます。
    * FL_12_0 HW は20.19.0000.0000 に21.19.65535.65535 を使用できます。
    * FL_12_1 HW は20.20.0000.0000 に21.20.65535.65535 を使用できます。
