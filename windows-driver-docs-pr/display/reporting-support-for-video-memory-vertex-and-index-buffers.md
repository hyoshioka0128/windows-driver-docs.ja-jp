---
title: ビデオ メモリの頂点バッファーとインデックス バッファーに対するサポートのレポート
description: ビデオ メモリの頂点バッファーとインデックス バッファーに対するサポートのレポート
...
ms.locfileid: "63383231"
---
# <a name="reporting-support-for-video-memory-vertex-and-index-buffers"></a>ビデオ メモリの頂点バッファーとインデックス バッファーに対するサポートのレポート
