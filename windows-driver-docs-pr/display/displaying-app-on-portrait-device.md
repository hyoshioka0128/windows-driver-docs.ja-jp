---
title: 縦のデバイスでアプリを表示するためのコード例
description: ここでは、縦向きのデバイスで正しく表示するアプリを作成するために使用できるコードです。
...
ms.locfileid: "56560019"
---
# <a name="example-code-for-displaying-an-app-on-a-portrait-device"></a>縦のデバイスでアプリを表示するためのコード例


ここでは、縦向きのデバイスで正しく表示するアプリを作成するために使用できるコードです。
