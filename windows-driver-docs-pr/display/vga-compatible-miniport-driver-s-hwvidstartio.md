---
title: VGA と互換性のあるミニポート ドライバーの HwVidStartIO
description: VGA と互換性のあるミニポート ドライバーの HwVidStartIO
...
ms.locfileid: "56527428"
---
# <a name="vga-compatible-miniport-drivers-hwvidstartio"></a>VGA と互換性のあるミニポート ドライバーの HwVidStartIO
