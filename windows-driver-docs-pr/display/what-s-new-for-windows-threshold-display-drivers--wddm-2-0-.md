...
詳細については、[WDDM 2.1 機能](wddm-2-1-features.md)を参照してください。
...
詳細については、[WDDM 2.0 での GPU 仮想メモリ](gpu-virtual-memory-in-wddm-2-0.md)を参照してください。
...
詳細については、[WDDM 2.0 でのドライバーの常駐](driver-residency-in-wddm-2-0.md)を参照してください。