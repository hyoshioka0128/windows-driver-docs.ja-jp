---
title: COPP ビデオのミニポート ドライバー シーケンス開始テンプレート コード
description: COPP ビデオのミニポート ドライバー シーケンス開始テンプレート コード
...
ms.locfileid: "56537186"
---
# <a name="copp-video-miniport-driver-sequence-start-template-code"></a>COPP ビデオのミニポート ドライバー シーケンス開始テンプレート コード
