---
title: 結合がデインター レース、ビデオ サブストリーム合成
description: 結合がデインター レース、ビデオ サブストリーム合成
...
ms.locfileid: "56531031"
---
# <a name="combining-deinterlacing-and-video-substream-compositing"></a>結合がデインター レース、ビデオ サブストリーム合成
