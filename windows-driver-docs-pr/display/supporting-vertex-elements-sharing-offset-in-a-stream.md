---
title: 頂点要素のオフセット、Stream での共有をサポートしています。
description: 頂点要素のオフセット、Stream での共有をサポートしています。
...
ms.locfileid: "56531376"
---
# <a name="supporting-vertex-elements-sharing-offset-in-a-stream"></a>頂点要素のオフセット、Stream での共有をサポートしています。
