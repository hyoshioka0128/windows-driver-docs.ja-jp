---
title: 圧縮されたテクスチャ サーフェスのレポートの幅と高さ
description: 圧縮されたテクスチャ サーフェスのレポートの幅と高さ
...
ms.locfileid: "56560829"
---
# <a name="reporting-width-and-height-of-compressed-texture-surfaces"></a>圧縮されたテクスチャ サーフェスのレポートの幅と高さ
