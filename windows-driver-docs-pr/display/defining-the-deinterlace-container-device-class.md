---
title: デインターレース コンテナー デバイス クラスの定義
description: デインターレース コンテナー デバイス クラスの定義
...
ms.locfileid: "63367924"
---
# <a name="defining-the-deinterlace-container-device-class"></a>デインターレース コンテナー デバイス クラスの定義
...
インター コンテナーのデバイス クラスを定義するのにには、次のコード例を使用します。
