...
description: DirectDraw から ProcAmp コントロール機能にアクセス[補正コールバック関数のモーション](motion-compensation-callbacks.md)にマップし、 [ProcAmp コントロール DDI](https://msdn.microsoft.com/library/windows/hardware/ff569186)します。
