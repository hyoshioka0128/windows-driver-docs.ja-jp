...
description: IoAllocateFree ルールは、以前に IoAllocateIrp で割り当てられた Irp でのみ、ドライバーが IoFreeIrp を使用する必要があることを指定します。
...
ms.locfileid: "72839963"
---
# <a name="ioallocatefree-rule"></a>IoAllocateFree ルール


**Ioallocatefree**ルールは、以前に[**ioallocateirp**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ioallocateirp)で割り当てられた irp でのみ、ドライバーが[**iofreeirp**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-iofreeirp)を使用する必要があることを指定します。
...
<tbody>
<tr class="odd">
<td align="left"><p><a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静的ドライバー検証ツール</a>を実行し、 <strong>Ioallocatefree</strong>ルールを指定します。</p>
