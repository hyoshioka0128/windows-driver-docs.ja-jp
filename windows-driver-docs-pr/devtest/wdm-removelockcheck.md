...
description: RemoveLockCheck 規則は、IoAcquireRemoveLock と IoReleaseRemoveLockAndWait の呼び出しが、MinorFunction\_IRP で\_PNP を\_処理するときに正しく使用されることを検証し、\_デバイス\_削除します。
