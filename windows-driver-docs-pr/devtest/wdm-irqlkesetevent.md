...
description: IrqlKeSetEvent ルールでは、IRQL のディスパッチに KeSetEvent ルーチンがのみ呼び出されることを指定します\_レベルと IRQL APC を FALSE に設定すると、待機\_レベルの待機が TRUE に設定します。
