...
ms.locfileid: "63342793"
---
# <a name="queuedspinlock-rule-wdm"></a>QueuedSpinLock ルール (wdm)


**QueuedSpinLock**ルールでは、ドライバーを呼び出すことを指定します[ **KeAcquireInStackQueuedSpinLock** ](https://msdn.microsoft.com/library/windows/hardware/ff551899)呼び出す前に[ **KeReleaseInStackQueuedSpinLock** ](https://msdn.microsoft.com/library/windows/hardware/ff553130)ドライバーを呼び出すと**KeReleaseInStackQueuedSpinLock**への後続の呼び出しの前に**KeAcquireInStackQueuedSpinLock**.
...
|                                   |                                                                                                                                       |
|-----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| この規則で見つかったバグ チェック | [**バグ チェック 0xC4 の。ドライバー\_VERIFIER\_検出\_違反**](https://msdn.microsoft.com/library/windows/hardware/ff560187) (0x00040006) |
