...
description: RemoveLock 規則は、IoAcquireRemoveLock と IoReleaseRemoveLock の呼び出しが正しく使用されることを指定します。 さらに、IRP \_ MJ \_ PNP または irp MJ POWER ルーチンの最後では、 \_ \_ ドライバーは removelock を保持しません。
