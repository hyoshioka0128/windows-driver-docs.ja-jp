...
description: MarkPowerDown ルールでは、irp \_ MJ \_ Power ON \_ \_ \_ SystemPowerState Irp が s0 から \ S1 に移行するように指定しています...S5 \ は保留されています。
...
ms.locfileid: "85917855"
---
# <a name="markpowerdown-rule-wdm"></a>MarkPowerDown ルール (wdm)


**MarkPowerDown**ルールでは、irp \_ MJ \_ パワーと irp を使用して \_ \_ \_ **SystemPowerState** IRP を s0 から S1 に移行 \[ するように指定しています...S5 \] は保留されています。
