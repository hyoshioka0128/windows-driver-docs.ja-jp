...
ms.locfileid: "56539270"
---
# <a name="evtioresumegetparam-rule-kmdf"></a>EvtIoResumeGetParam ルール (kmdf)


**EvtIoResumeGetParam**ルールを指定する[ **WdfRequestGetParameters** ](https://msdn.microsoft.com/library/windows/hardware/ff549969)内では呼び出されません、 **EvtIoResumeGetParam**コールバック関数。
...
<tbody>
<tr class="odd">
<td align="left"><p>実行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>を指定し、 <strong>EvtIoResumeGetParam</strong>ルール。</p>
