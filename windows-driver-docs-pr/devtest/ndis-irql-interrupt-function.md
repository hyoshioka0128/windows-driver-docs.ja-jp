---
title: Irql\_割り込み\_関数規則 (ndis)
description: Irql\_Interrupt\_関数規則は、割り込みのための NDIS 関数を正しい IRQL レベルで呼び出す必要があることを指定します。
...
ms.locfileid: "72840110"
---
# <a name="irql_interrupt_function-rule-ndis"></a>Irql\_割り込み\_関数規則 (ndis)


Irql\_Interrupt\_関数規則は、割り込みのための NDIS 関数を正しい IRQL レベルで呼び出す必要があることを指定します。
