...
description: MarkDevicePower ルールでは、irp への SystemPowerState IRP の電源がオンになっている IRP\_MJ\_\_\_\_電源がオンになっていることを指定します。
...
ms.locfileid: "72839168"
---
# <a name="markdevicepower-rule-wdm"></a>MarkDevicePower ルール (wdm)


**Markdevicepower**ルールでは、irp への SystemPowerState irp の電源がオンになっている IRP\_MJ\_\_\_\_電源がオンになっていることを指定します。
