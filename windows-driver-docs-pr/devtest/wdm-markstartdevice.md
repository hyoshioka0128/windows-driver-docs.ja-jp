...
description: MarkStartDevice ルールは、ドライバーが IRP pends \_ \_ START device irp を正しく実行することを指定し \_ ます。 このルールは、FDO および FIDO ドライバーにのみ適用されます。
...
ms.locfileid: "85917267"
---
# <a name="markstartdevice-rule-wdm"></a>MarkStartDevice ルール (wdm)


**Markstartdevice**ルールは、ドライバーが irp pends \_ \_ START device irp を正しく実行することを指定し \_ ます。 このルールは、FDO および FIDO ドライバーにのみ適用されます。
