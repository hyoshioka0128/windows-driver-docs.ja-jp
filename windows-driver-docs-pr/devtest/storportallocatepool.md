...
ms.locfileid: "67391780"
---
# <a name="storportallocatepool-rule-storport"></a>StorPortAllocatePool ルール (storport)


このルールは、ミニポートが呼び出しを試みる必要がありますいないを確認します。 [ **StorPortFreePool** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/storport/nf-storport-storportfreepool) 、割り当てが解除されたバッファーにします。
...
<tbody>
<tr class="odd">
<td align="left"><p>実行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>を指定し、 <strong>StorPortAllocatePool</strong>ルール。</p>
