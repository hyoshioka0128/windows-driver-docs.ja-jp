---
title: DriverCreate ルール (kmdf)
description: DriverCreate ルールは、カーネルモードドライバーフレームワーク (KMDF) を使用するドライバーが、Drivercreate ルーチン内からフレームワークドライバーオブジェクトを作成するために、WdfDriverCreate メソッドを呼び出す必要があることを指定します。
ms.assetid: a994fd72-4fb2-486b-9d5e-80dedd940c85
ms.date: 05/21/2018
keywords:
- DriverCreate ルール (kmdf)
topic_type:
- apiref
api_name:
- DriverCreate
...
ms.locfileid: "72839508"
---
# <a name="drivercreate-rule-kmdf"></a>DriverCreate ルール (kmdf)


**Drivercreate**ルールは、カーネルモードドライバーフレームワーク (kmdf) を使用するドライバーが、 [**drivercreate**](https://docs.microsoft.com/windows-hardware/drivers/wdf/driverentry-for-kmdf-drivers)ルーチン内からフレームワークドライバーオブジェクトを作成するために、 [**wdfdrivercreate**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdfdriver/nf-wdfdriver-wdfdrivercreate)メソッドを呼び出す必要があることを指定します。
...
<tbody>
<tr class="odd">
<td align="left"><p><a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静的ドライバー検証ツール</a>を実行し、 <strong>drivercreate</strong>ルールを指定します。</p>
