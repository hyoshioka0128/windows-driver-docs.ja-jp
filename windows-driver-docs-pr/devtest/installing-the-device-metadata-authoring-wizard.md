---
title: デバイスのメタデータの編集ウィザードのインストール
description: デバイスのメタデータの編集ウィザードのインストール
...
ms.locfileid: "56536753"
---
# <a name="installing-the-device-metadata-authoring-wizard"></a>デバイスのメタデータの編集ウィザードのインストール
