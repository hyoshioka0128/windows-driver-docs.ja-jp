...
-   新しいメタデータ パッケージを作成するには、次のように選択します。**デバイス メタデータ パッケージの新規作成**、順にクリックします**次**します。
-   既存のメタデータ パッケージを更新するには、次のように選択します。**既存のデバイス メタデータ パッケージの更新**、 をクリック**参照**、パッケージを選択し、クリックする**次へ**します。

通信事業者アプリの開発に関する詳細については、次を参照してください。[モバイル ブロード バンド。デバイス アプリを UWP](https://go.microsoft.com/fwlink/p/?linkid=241446)します。
