...
ms.locfileid: "56528730"
---
# <a name="makecat"></a>MakeCat


MakeCat (Makecat.exe) は、コマンド ライン[CryptoAPI](https://go.microsoft.com/fwlink/p/?linkid=136391)作成ツール、[カタログ ファイル](https://msdn.microsoft.com/library/windows/hardware/ff537872)の[ドライバー パッケージ](https://msdn.microsoft.com/library/windows/hardware/ff544840)します。
