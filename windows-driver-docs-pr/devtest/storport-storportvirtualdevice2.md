...
description: このルールは、HwStorFindAdapter ルーチンが終了したときに、PORT\_CONFIGURATION\_INFORMATION (Storport) 構造の VirtualDevice フィールドが TRUE に設定されていることを確認します。 このルールは、バーチャル StorPort ミニポートにのみ適用されます。
