...
ms.locfileid: "63386397"
---
# <a name="memafterreqcompletedioctl-rule-kmdf"></a>MemAfterReqCompletedIoctl ルール (kmdf)


**MemAfterReqCompletedIoctl**ルールでは、ことを指定します、 [ *EvtIoDeviceControl* ](https://msdn.microsoft.com/library/windows/hardware/ff541758)コールバック関数では後は、framework のメモリ オブジェクトにアクセスできません/O 要求が完了したとします。
...
<tbody>
<tr class="odd">
<td align="left"><p>実行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>を指定し、 <strong>MemAfterReqCompletedIoctl</strong>ルール。</p>
