...
description: IoBuildSynchronousFsdRequestWait 規則は、IoCallDriver または PoCallDriver が STATUS\_PENDING を返す場合に KeWaitForSingleObject を呼び出すように指定します。
