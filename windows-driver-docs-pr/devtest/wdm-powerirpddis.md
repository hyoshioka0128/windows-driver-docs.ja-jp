...
description: PowerIrpDDIs ルールでは、ドライバーがシステムまたはデバイスの\_IRP を処理しているときに、IRP\_\_\_電源をオンにして電力を供給している場合は、パッシブ\_レベルでのみ呼び出すことができる DDIs を呼び出さないように指定します。\_
...
ms.locfileid: "78289781"
---
# <a name="powerirpddis-rule-wdm"></a>PowerIrpDDIs ルール (wdm)


**Powerirpddis**ルールでは、ドライバーがシステムまたはデバイスの\_irp を処理しているときに、irp\_\_\_電源をオンにして電力を供給している場合は、パッシブ\_レベルでのみ呼び出すことができる DDIs を呼び出さないように指定します。\_
