...
ms.locfileid: "56538916"
---
# <a name="removelockforwarddevicecontrol-rule-wdm"></a>RemoveLockForwardDeviceControl ルール (wdm)


**RemoveLockForwardDeviceControl**への呼び出し規則を確認します[ **IoAcquireRemoveLock** ](https://msdn.microsoft.com/library/windows/hardware/ff548204)と[ **IoReleaseRemoveLock**](https://msdn.microsoft.com/library/windows/hardware/ff549560)ドライバーを使用する場合が正しく使用[**保留**](https://msdn.microsoft.com/library/windows/hardware/ff548336) IRP を別のデバイスを転送します。
...
<tbody>
<tr class="odd">
<td align="left"><p>実行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>を指定し、 <strong>RemoveLockForwardDeviceControl</strong>ルール。</p>
