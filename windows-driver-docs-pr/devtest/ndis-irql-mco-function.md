---
title: Irql \_ mco \_ 関数ルール (ndis)
description: Irql \_ mco 関数ルールでは、 \_ ミニポートドライバーの NDIS Mco DDIs を正しい Irql レベルで呼び出す必要があることを指定します。
ms.assetid: 4a6643a2-d831-4b60-a9d6-decf494a2ffc
ms.date: 05/21/2018
keywords:
- Irql_MCO_Function 規則 (ndis)
topic_type:
- apiref
api_name:
- Irql_MCO_Function
...
ms.locfileid: "85916541"
---
# <a name="irql_mco_function-rule-ndis"></a>Irql \_ mco \_ 関数ルール (ndis)


**Irql \_ mco \_ 関数**ルールでは、ミニポートドライバーの NDIS mco DDIs を正しい Irql レベルで呼び出す必要があることを指定します。
