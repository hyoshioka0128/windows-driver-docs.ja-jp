...
ms.locfileid: "67392376"
---
# <a name="initderegisterinterrupt-rule-ndis"></a>Init\_DeRegisterInterrupt ルール (ndis)


**Init\_DeRegisterInterrupt**規則で指定された場合[ **NdisMRegisterInterruptEx** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/nf-ndis-ndismregisterinterruptex) MPInitilize、中に少なくとも 1 回呼び出される[ **NdisMDeregisterInterruptEx** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/nf-ndis-ndismderegisterinterruptex) MPHaltEx で少なくとも 1 回呼び出す必要があります。
...
<tbody>
<tr class="odd">
<td align="left"><p>実行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>を指定し、 <strong>Init_DeRegisterInterrupt</strong>ルール。</p>
