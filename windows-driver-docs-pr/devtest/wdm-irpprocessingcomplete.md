...
description: IrpProcessingComplete ルールでは、ディスパッチルーチンが STATUS SUCCESS を返す場合 \_ 、IRP はドライバー自体または下位レベルのドライバーによって完了されている必要があることを指定します。
...
ms.locfileid: "85917612"
---
# <a name="irpprocessingcomplete-rule-wdm"></a>IrpProcessingComplete ルール (wdm)


**Irpprocessingcomplete**ルールでは、ディスパッチルーチンが STATUS SUCCESS を返す場合 \_ 、IRP はドライバー自体または下位レベルのドライバーによって完了されている必要があることを指定します。
