---
title: BufAfterReqCompletedIoctl ルール (kmdf)
description: BufAfterReqCompletedIoctl ルールは、EvtIoDeviceControl コールバック関数内で i/o 要求の完了後に取得される i/o 要求バッファーにアクセスできないことを指定します。
ms.assetid: 24a7e993-af9c-4e90-9213-74778826326d
ms.date: 05/21/2018
keywords:
- BufAfterReqCompletedIoctl ルール (kmdf)
topic_type:
- apiref
api_name:
...
ms.locfileid: "85917098"
---
# <a name="bufafterreqcompletedioctl-rule-kmdf"></a>BufAfterReqCompletedIoctl ルール (kmdf)


**BufAfterReqCompletedIoctl**ルールは、 [*Evtiodevicecontrol*](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdfio/nc-wdfio-evt_wdf_io_queue_io_device_control)コールバック関数内で i/o 要求の完了後に取得される i/o 要求バッファーにアクセスできないことを指定します。
...
<tbody>
<tr class="odd">
<td align="left"><p><a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静的ドライバー検証ツール</a>を実行し、 <strong>BufAfterReqCompletedIoctl</strong>規則を指定します。</p>
...
[**WdfRequestRetrieveUnsafeUserOutputBuffer**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdfrequest/nf-wdfrequest-wdfrequestretrieveunsafeuseroutputbuffer)関連項目
--------
