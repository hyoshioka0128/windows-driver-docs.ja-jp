---
title: コントロール GUID でのトレース セッションの作成
description: コントロール GUID でのトレース セッションの作成
...
ms.locfileid: "63347764"
---
# <a name="creating-a-trace-session-with-a-control-guid"></a>コントロール GUID でのトレース セッションの作成
