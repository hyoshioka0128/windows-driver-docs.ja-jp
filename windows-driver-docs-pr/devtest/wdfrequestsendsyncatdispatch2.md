...
ms.locfileid: "63345660"
---
# <a name="wdfrequestsendsyncatdispatch2-rule-kmdf"></a>WdfRequestSendSyncAtDispatch2 ルール (kmdf)


**WdfRequestSendSyncAtDispatch2**ルールを確認、 [ **WdfRequestSend** ](https://msdn.microsoft.com/library/windows/hardware/ff550027)関数は、適切な IRQL の優先度レベルで送信します。
...
<tbody>
<tr class="odd">
<td align="left"><p>実行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>を指定し、 <strong>WdfRequestSendSyncAtDispatch2</strong>ルール。</p>
