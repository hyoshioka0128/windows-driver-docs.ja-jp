...
更新プログラムまたはインストールは、読み取り専用属性を含む、Boot.ini で既定のセキュリティ属性を復元します。 ファイルを編集するには、Bootcfg コマンドを使用するか、ファイル属性を変更します。 詳細については、次を参照してください。 [Boot.ini ファイルの編集](editing-the-boot-ini-file.md)します。
