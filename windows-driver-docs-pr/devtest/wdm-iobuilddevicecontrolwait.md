...
description: IoBuildDeviceControlWait 規則は、IoCallDriver または PoCallDriver が PENDING 状態を返す場合に KeWaitForSingleObject ルーチンを呼び出すように指定し \_ ます。
