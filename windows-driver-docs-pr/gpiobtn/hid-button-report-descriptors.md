---
title: HID ボタンのレポート記述子
description: このトピックでには、HID ボタンのレポート記述子サンプルにはが含まれています。
...
ms.locfileid: "56535598"
---
# <a name="hid-button-report-descriptors"></a>HID ボタンのレポート記述子


このトピックでには、HID ボタンのレポート記述子サンプルにはが含まれています。
