---
title: サンプルの SetupAPI ログ ファイルの変換
description: サンプルの SetupAPI ログ ファイルの変換
ms.assetid: 86bef34e-1ff3-4777-9b7c-0f08645ff89f
keywords:
- サンプルは、WDK SetupAPI ログに記録します。
ms.date: 04/20/2017
...
ms.locfileid: "63353790"
---
# <a name="interpreting-a-sample-setupapi-log-file"></a>サンプルの SetupAPI ログ ファイルの変換





以下のサンプル ログは、SetupAPI ログ ファイルに含まれる情報を示しています。

一般に、ログ ファイルにすべてのインストールのすべての部分が表示されます。 インストール セクションでは、ログ形式のエントリから始まります\[*年/月/日の時刻プロセス id.instance 説明*\]場所*インスタンス*が確実に数2 つのセクションでは、同じプロセスを同時にインスタンス化が一意であります。

### <a href="" id="ddk-sample-windows-xp-setupapi-log-file-dg"></a>サンプルの Windows XP SetupAPI ログ ファイル

Windows xp では、各ログ エントリにはで構成されるメッセージの識別子が含まれていますの文字またはダッシュ (-) が続く番号。 次の表では、メッセージ識別子の形式について説明します。
...
<thead>
<tr class="header">
<th align="left">［メッセージ ID］</th>
<th align="left">メッセージ型</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<td align="left"><p>警告メッセージです。</p></td>
</tr>
<tr class="odd">
<td align="left"><p>#<em>Nnn</em></p></td>
<td align="left"><p>情報メッセージです。</p></td>
</tr>
<tr class="even">
<td align="left"><p>#T<em>nnn</em></p></td>
<td align="left"><p>タイミングのメッセージ。</p></td>
</tr>
<tr class="odd">
<td align="left"><p>#V<em>nnn</em></p></td>
<td align="left"><p>詳細メッセージ。</p></td>
</tr>
<tr class="even">
<td align="left"><p>#-<em>nnn</em></p></td>
<td align="left"><p>ステータス メッセージ。</p></td>
</tr>
</tbody>
</table>
