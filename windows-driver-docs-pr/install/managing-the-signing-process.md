...
### <a name="driver-signing-administration"></a>ドライバーの署名の管理

これは通常、発行元のプログラムの管理が処理とソフトウェア サービスのリリースし、次のトピックが含まれています。

-   [適切なシグネチャの種類の選択](selecting-the-appropriate-signature-type.md)

-   取得のために必要な[リリース証明書](release-certificates.md)または[テスト証明書](test-certificates.md)

-   [デジタル署名やコード署名キーの管理](managing-the-digital-signature-or-code-signing-keys.md)

### <a name="driver-development"></a>ドライバーの開発

これは通常、発行元の開発チームによって処理され、次が含まれています。
