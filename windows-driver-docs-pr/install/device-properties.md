---
title: デバイス プロパティ
description: デバイス プロパティ
ms.assetid: 87a43865-74bc-412c-9ae2-3ba38589c8f8
keywords:
- デバイスのインストール WDK、デバイスのプロパティ
...
デバイスのプロパティは、デバイスのインスタンスの属性を体系化[デバイス セットアップ クラス](device-setup-classes.md)、[デバイス インターフェイス クラス](device-interface-classes.md)、およびデバイスのインターフェイス。 これらの属性には、コンポーネントと、Windows オペレーティング システムでは、その構成の機能について説明します。

Windows Vista および Windows のサポートの以降のバージョン、[統一されたデバイス プロパティのモデル](unified-device-property-model--windows-vista-and-later-.md)これらのデバイス プロパティの表示方法を定義します。
