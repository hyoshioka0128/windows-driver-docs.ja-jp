---
title: テスト署名済みカタログ ファイルの署名の検証
description: テスト署名済みカタログ ファイルの署名の検証
...
ms.locfileid: "56557704"
---
# <a name="verifying-the-signature-of-a-test-signed-catalog-file"></a>テスト署名済みカタログ ファイルの署名の検証
