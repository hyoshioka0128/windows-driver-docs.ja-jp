---
title: 付録 2-Visual Studio でのドライバーの署名
description: Microsoft Visual Studio を使用して Windows デバイス ドライバーに署名する方法について説明します。
...
## <a name="driver-signing-using-visual-studio-development-environment"></a>Visual Studio 開発環境を使用してドライバーの署名
