---
title: デバイス メタデータ パッケージの手動での追加
description: デバイス メタデータ パッケージの手動での追加
...
ms.locfileid: "63378362"
---
# <a name="manually-adding-device-metadata-packages"></a>デバイス メタデータ パッケージの手動での追加
