...
1.  呼び出す[ **SetupDiGetClassInstallParams** ](https://msdn.microsoft.com/library/windows/hardware/ff551083)現在を取得するクラスは、デバイスのパラメーターをインストールします。 例:
