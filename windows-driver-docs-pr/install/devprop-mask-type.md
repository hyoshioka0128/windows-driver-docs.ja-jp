...
description: Windows Vista および以降のバージョンの Windows では、データ型のプロパティの識別子から基本データ型識別子を抽出するデータ型のプロパティの識別子を持つ DEVPROP_MASK_TYPE マスク ビットごとの AND で結合できます。
ms.assetid: 5d1d5cb2-d967-47b4-bde7-fdf4248b1913
keywords:
- DEVPROP_MASK_TYPE デバイスとドライバーのインストール
topic_type:
- apiref
api_name:
- DEVPROP_MASK_TYPE
