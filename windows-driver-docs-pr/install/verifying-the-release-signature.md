...
ms.locfileid: "67380432"
---
# <a name="verifying-the-release-signature"></a>リリース署名の検証


後に、[ドライバー パッケージ](driver-packages.md)リリース署名されて、 [ **SignTool** ](https://docs.microsoft.com/windows-hardware/drivers/devtest/signtool)の署名を検証するツールを使用できます。
