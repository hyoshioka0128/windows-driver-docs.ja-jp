...
ms.locfileid: "67378216"
---
# <a name="devpkeydeviceinstallstate"></a>DEVPKEY_Device_InstallState


DEVPKEY_Device_InstallState デバイス プロパティは、デバイスのインスタンスのインストール状態を表します。
...
Windows では、DEVPKEY_Device_InstallState の値を設定、CM_INSTALL_STATE_ のいずれかに*Xxx* Cfgmgr32.h で定義されている値。 CM_INSTALL_STATE_*Xxx*値に対応して、 [ **DEVICE_INSTALL_STATE** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ne-wdm-_device_install_state)列挙値。

呼び出すことができます[ **SetupDiGetDeviceProperty** ](https://docs.microsoft.com/windows/desktop/api/setupapi/nf-setupapi-setupdigetdevicepropertyw) DEVPKEY_Device_InstallState の値を取得します。

Windows Server 2003 および Windows XP は、このプロパティをサポートは DEVPKEY_Device_InstallState プロパティのキーをサポートしていません。 代わりに、Windows の以前のバージョンのプロパティの値へのアクセスに対応する SPDRP_INSTALL_STATE 識別子を使用することができます。 Windows の以前のバージョンでこのプロパティの値にアクセスする方法については、次を参照してください。[デバイス インスタンス SPDRP_Xxx プロパティへのアクセス](https://docs.microsoft.com/windows-hardware/drivers/install/accessing-device-instance-spdrp-xxx-properties)します。
