...
keywords:
- デバイスとドライバーのインストールの DEVPKEY_Device_BusNumber
topic_type:
- apiref
api_name:
...
ms.locfileid: "86418312"
---
# <a name="devpkey_device_busnumber"></a>DEVPKEY_Device_BusNumber


DEVPKEY_Device_BusNumber デバイスプロパティは、デバイスインスタンスがアタッチされているバスインスタンスを識別する番号を表します。
...
Windows は、DEVPKEY_Device_BusNumber の値を、 [**IRP_MN_QUERY_BUS_INFORMATION**](https://docs.microsoft.com/windows-hardware/drivers/kernel/irp-mn-query-bus-information)要求に応答してバスドライバーが返す[**PNP_BUS_INFORMATION**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/ns-wdm-_pnp_bus_information)構造体の busnumber メンバーの値に設定します。
...
Windows Server 2003、Windows XP、および Windows 2000 は、このプロパティをサポートしていますが、DEVPKEY_Device_BusNumber プロパティキーをサポートしていません。 代わりに、対応する SPDRP_BUSNUMBER 識別子を使用して、これらの以前のバージョンの Windows でプロパティの値にアクセスできます。 以前のバージョンの Windows でこのプロパティ値にアクセスする方法の詳細については、「[デバイスインスタンス](https://docs.microsoft.com/windows-hardware/drivers/install/accessing-device-instance-spdrp-xxx-properties)へのアクセス SPDRP_Xxx のプロパティ」を参照してください。
