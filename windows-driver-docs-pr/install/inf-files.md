...
-   [INF ファイルの概要](overview-of-inf-files.md)
-   [デバイスのインストール アプリケーションから INF ファイルへのアクセス](accessing-inf-files-from-a-setup-application.md)
-   [シェルと自動再生のベンダーのアイコンを提供します。](providing-vendor-icons-for-the-shell-and-autoplay.md)
