...
keywords:
- デバイスとドライバーのインストールの DEVPKEY_Device_Children
topic_type:
- apiref
api_name:
...
ms.locfileid: "86418503"
---
# <a name="devpkey_device_children"></a>DEVPKEY_Device_Children


DEVPKEY_Device_Children デバイスプロパティは、デバイスインスタンスの子であるデバイスのデバイスインスタンス Id の一覧を表します。
...
[**Setupdigetdeviceproperty**](https://docs.microsoft.com/windows/desktop/api/setupapi/nf-setupapi-setupdigetdevicepropertyw)を呼び出して、DEVPKEY_Device_Children の値を取得できます。
