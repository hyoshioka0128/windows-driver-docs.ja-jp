...
keywords:
- デバイスとドライバーのインストールの DEVPKEY_Device_PowerRelations
topic_type:
- apiref
api_name:
...
ms.locfileid: "86418197"
---
# <a name="devpkey_device_powerrelations"></a>DEVPKEY_Device_PowerRelations


DEVPKEY_Device_PowerRelations デバイスプロパティは、デバイスインスタンスの[**電源の関係**](https://docs.microsoft.com/windows-hardware/drivers/kernel/irp-mn-query-device-relations)を表します。
...
[**Setupdigetdeviceproperty**](https://docs.microsoft.com/windows/desktop/api/setupapi/nf-setupapi-setupdigetdevicepropertyw)を呼び出して、DEVPKEY_Device_PowerRelations の値を取得できます。
