...
デバイスインターフェイスクラスを識別する GUID 値を指定します。 これは、 **{**<em>nnnnnnnn</em>**-***nnnn***--nnnn nnnnnnnn-nnnn-nnnn-nnnn-nnnnnnnnnnnn} という形式の明示的な GUID 値として、または INF ファイルの文字列セクションで "{nnnnnnnn****-****** **"{**<em>nnnnnnnn</em>**-***nnnn***-****-* nnnn nnnn***-**<em>nnnnnnnn-nnnn-nnnn-nnnn-nnnnnnnnnnnn</em>**}"** に[**Strings**](inf-strings-section.md)定義されている%*strkey*% token として表すことができます。<em>nnnnnnnnnnnn</em>**}**
