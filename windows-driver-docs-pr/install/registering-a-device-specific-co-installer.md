---
title: デバイスに固有の共同インストーラーを登録します。
description: デバイスに固有の共同インストーラーを登録します。
...
ms.locfileid: "56536028"
---
# <a name="registering-a-device-specific-co-installer"></a>デバイスに固有の共同インストーラーを登録します。
