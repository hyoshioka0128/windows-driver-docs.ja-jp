---
title: PC カードを構成するための INF オーバーライドを中断します。
description: PC カードを構成するための INF オーバーライドを中断します。
...
ms.locfileid: "56559534"
---
# <a name="inf-override-for-configuring-pc-card-interrupts"></a>PC カードを構成するための INF オーバーライドを中断します。
