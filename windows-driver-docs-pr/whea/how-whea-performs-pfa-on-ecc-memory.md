---
title: WHEA が ECC メモリ PFA を実行する方法
description: WHEA が ECC メモリ PFA を実行する方法
...
ms.locfileid: "56553259"
---
# <a name="how-whea-performs-pfa-on-ecc-memory"></a>WHEA が ECC メモリ PFA を実行する方法
