...
ポリシーの種類、ユーザーが指定されたコントロール以外のエンドポイントを設定しようとしています。 詳細については、[EFI\_USBFN\_ポリシー\_型](efi-usbfn-policy-type.md)を参照してください。

<a href="" id="buffersize"></a>*BufferSize*  
サイズ*バッファー* (バイト単位)。

<a href="" id="buffer"></a>*バッファー*  
新しいエンドポイント ポリシーの値を格納しているバッファーへのポインター。 ポリシーの種類のサイズ要件の詳細については、[EFI\_USBFN\_ポリシー\_型](efi-usbfn-policy-type.md)を参照してください。
