...
|              |                                                                                                                  |
|--------------|------------------------------------------------------------------------------------------------------------------|
| USB ルートハブ | ホストコントローラーの子のみ。 ADR は0である必要があり \_ ます。 ADR の他の子または値は使用できません \_ 。 |
| USB ポート    | ポート番号 (1 ~ n)                                                                                                |
...
|     |     |
| --- | --- |
| 複合 USB デバイス内の USB 機能 | 複合デバイスが接続されているポートのポート番号と、関数の最初のインターフェイス番号。 (算術加算)。 |
