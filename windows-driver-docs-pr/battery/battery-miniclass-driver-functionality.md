---
title: バッテリ Miniclass ドライバーの機能
description: バッテリ Miniclass ドライバーの機能
...
ms.locfileid: "56558823"
---
# <a name="battery-miniclass-driver-functionality"></a>バッテリ Miniclass ドライバーの機能
