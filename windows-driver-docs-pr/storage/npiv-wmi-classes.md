...
ms.locfileid: "56571921"
---
# <a name="npiv-wmi-classes"></a>NPIV WMI クラス


NPIV WMI クラスが定義されている*npivwmi.mof*します。 これらのクラスは、HBA ポートの仮想化を管理するためのインターフェイスを提供します。

次のトピックでは、NPIV WMI インターフェイスを構成するクラスについて説明します。

[MSFC\_DH\_CHAP\_パラメーター WMI クラス](msfc-dh-chap-parameters-wmi-class.md)

[MSFC\_FibrePortNPIVAttributes WMI クラス](msfc-fibreportnpivattributes-wmi-class.md)
