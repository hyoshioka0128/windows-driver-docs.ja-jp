---
title: NVM の有効期間率の警告しきい値 (関数のインデックス 6) の設定します。
...
ms.locfileid: "56551739"
---
# <a name="set-nvm-lifetime-percentage-warning-threshold-function-index-6"></a>NVM の有効期間率の警告しきい値 (関数のインデックス 6) の設定します。
