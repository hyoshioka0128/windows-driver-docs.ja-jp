...
このクラスの定義が WMI ツール スイートによってコンパイルされると、生成、 [ **DSM\_ロード\_残高\_ポリシー\_V2** ](https://msdn.microsoft.com/library/windows/hardware/ff552698)データ構造体。 この WMI クラスに関連付けられているメソッドはありません。
