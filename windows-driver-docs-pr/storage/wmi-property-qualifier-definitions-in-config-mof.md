...
定義されている WMI 修飾子*Config.mof* iSCSI ソフトウェアでは、使用して、ネットワークの構成を示すデータ形式のいくつかを指定します。

*Config.mof*ファイルは、次の WMI プロパティ修飾子を定義します。

[暗号化\_型\_修飾子](encryption-types-qualifiers.md)
