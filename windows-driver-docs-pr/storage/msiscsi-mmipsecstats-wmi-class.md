...
ms.locfileid: "72845345"
---
# <a name="msiscsi_mmipsecstats-wmi-class"></a>MSiSCSI\_MMIPSECStats WMI クラス


## <span id="ddk_msiscsi_mmipsecstats_wmi_class_kr"></span><span id="DDK_MSISCSI_MMIPSECSTATS_WMI_CLASS_KR"></span>


MSiSCSI\_MMIPSECStats WMI クラスは、メインモードの IPsec 統計情報を公開します。
...
WMI ツールスイートは、前のクラス定義をコンパイルするときに、 [**Msiscsi\_MMIPSECStats**](https://docs.microsoft.com/windows-hardware/drivers/ddi/iscsiprf/ns-iscsiprf-_msiscsi_mmipsecstats)データ構造体を生成します。
