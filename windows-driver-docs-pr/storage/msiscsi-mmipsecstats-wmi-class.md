---
title: MSiSCSI\_MMIPSECStats WMI クラス
description: MSiSCSI\_MMIPSECStats WMI クラス
...
ms.locfileid: "67384679"
---
# <a name="msiscsimmipsecstats-wmi-class"></a>MSiSCSI\_MMIPSECStats WMI クラス


## <span id="ddk_msiscsi_mmipsecstats_wmi_class_kr"></span><span id="DDK_MSISCSI_MMIPSECSTATS_WMI_CLASS_KR"></span>


MSiSCSI\_MMIPSECStats WMI クラスは、メイン モード IPsec 統計情報を公開します。
...
WMI ツールのスイートでは、上記のクラス定義をコンパイルするときに生成、 [ **MSiSCSI\_MMIPSECStats** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/iscsiprf/ns-iscsiprf-_msiscsi_mmipsecstats)データ構造体。
