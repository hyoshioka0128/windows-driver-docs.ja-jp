---
title: ISCSI\_DiscoveredTarget2 WMI クラス
description: ISCSI\_DiscoveredTarget2 WMI クラス
...
ms.locfileid: "56574624"
---
# <a name="iscsidiscoveredtarget2-wmi-class"></a>ISCSI\_DiscoveredTarget2 WMI クラス


ISCSI\_DiscoveredTarget2 WMI クラスが検出されたターゲットに関連する情報を提供します。

このクラスと似ています、 [ISCSI\_DiscoveredTarget WMI クラス](iscsi-discoveredtarget-wmi-class.md)が ISCSI\_DiscoveredTarget2 にはターゲット ポータルの情報が含まれている ISCSI\_DiscoveredTarget WMI クラスはありませんある場合は、ポータルのグループのタグ番号などです。
