---
title: ベンダー提供の IDE コントローラー ミニドライバーの要件
...
ms.locfileid: "63352628"
---
# <a name="requirements-for-vendor-supplied-ide-controller-minidrivers"></a>ベンダー提供の IDE コントローラー ミニドライバーの要件
