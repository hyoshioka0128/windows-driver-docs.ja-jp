...
*HBAStatus*   
操作の状態。 使用できる値とその説明の一覧は、[HBA\_状態](hba-status.md)を参照してください。 ミニポート ドライバーでは、この情報を返します、SM の HBAStatus メンバー\_RemoveTarget\_構造体。
...
[**SM\_RemoveTarget\_アウト**](https://msdn.microsoft.com/library/windows/hardware/ff566283)
