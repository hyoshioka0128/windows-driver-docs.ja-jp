---
title: 記憶域フィルター ドライバーのデバイスの種類に固有の機能
description: 記憶域フィルター ドライバーのデバイスの種類に固有の機能
...
ms.locfileid: "56538203"
---
# <a name="storage-filter-drivers-device-type-specific-functionality"></a>記憶域フィルター ドライバーのデバイスの種類に固有の機能
...
一般に、SFD には、それらの要求をデバイスに固有の処理を必要とする記憶域クラス ドライバーとして同じ責任があります。 記憶域クラス ドライバーの必要な機能の詳細については、[ストレージ クラス ドライバー](storage-class-drivers.md)を参照してください。
