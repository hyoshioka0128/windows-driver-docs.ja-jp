...
ms.locfileid: "56529963"
---
# <a name="ipm-configuration-and-usage"></a>IPM 構成と使用状況
...
これは、ハードウェア キーをサービス キーではなく HKR が指す場所、INF ファイルの DDInstall.HW セクション内からのみ実行できます。 INF ファイルを変更する方法の詳細については、[ドライバーのレジストリ キーの概要](https://go.microsoft.com/fwlink/p/?linkid=144533)を参照してください。
