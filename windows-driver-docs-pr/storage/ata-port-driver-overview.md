---
title: ATA ポートドライバーの概要
description: ATA ポートドライバーの概要
...
ms.locfileid: "72262178"
---
# <a name="ata-port-driver-overview"></a>ATA ポートドライバーの概要
