---
title: 実装されている関数のクエリ (関数インデックス 0)
description: この関数は、このインターフェイスのバージョンでサポートされている関数を返します。
...
この関数は、順序で次のバイト値を含む、ACPI バッファーを返します。0 xff の場合、0 xff の場合、0 xff & 0 xff までです。
