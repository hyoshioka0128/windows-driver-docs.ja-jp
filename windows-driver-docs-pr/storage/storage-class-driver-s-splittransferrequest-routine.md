---
title: 記憶域クラス ドライバー SplitTransferRequest ルーチン
description: 記憶域クラス ドライバー SplitTransferRequest ルーチン
...
ms.locfileid: "56530000"
---
# <a name="storage-class-drivers-splittransferrequest-routine"></a>記憶域クラス ドライバー SplitTransferRequest ルーチン
