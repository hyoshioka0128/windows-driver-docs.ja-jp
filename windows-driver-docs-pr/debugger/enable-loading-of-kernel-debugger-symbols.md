---
title: カーネル デバッガーのシンボルの読み込みを有効にします。
description: カーネル デバッガーのシンボルの読み込みを有効にします。
...
ms.locfileid: "56531698"
---
# <a name="enable-loading-of-kernel-debugger-symbols"></a>カーネル デバッガーのシンボルの読み込みを有効にします。
