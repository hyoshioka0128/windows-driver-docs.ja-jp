...
特定のオプションを有効にするかどうかを指定します (正符号 \[ @ no__t @ no__t)。またはオフ (マイナス記号 \[ @ no__t @ no__t)。
...
*オプション*を省略した場合は、以前に設定したオプションが表示されます。 この場合、 **l +** と**l**コマンドは同じ効果を持ちます。 ただし、 **l**コマンドを機能させるには、正符号 ( **+** ) または負符号 (-) を含める必要があります。
