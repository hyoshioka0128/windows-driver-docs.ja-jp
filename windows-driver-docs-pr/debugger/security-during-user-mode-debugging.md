...
予期しないリモート接続を防ぐ方法の推奨事項は、[セキュリティ リモート デバッグ中に](security-during-remote-debugging.md)を参照してください。 ユーザー モードのデバッグ セッションをリモート クライアントの参加後、コンピューター上のプロセスへのアクセスを制限する方法はありません。
