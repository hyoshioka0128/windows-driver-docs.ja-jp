...
2. ホストシステムの IP アドレスを記録する: \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
1.  **GitHub から KMDF Echo サンプルをダウンロードして抽出する**
    ...
    」を参照します。 このラボでは、ユニバーサルドライバーのサンプルを1つの zip ファイルにダウンロードする方法を示します。
...
2.  **Visual Studio でドライバーソリューションを開く**
    ...
    Microsoft Visual Studio で、[&gt;**ファイル**] をクリックし &gt;**プロジェクト/ソリューション...** を**開き**、抽出したファイルが格納されているフォルダーに移動します (例: *C:\\driversamples\\全般\\echo\\kmdf*)。 *Kmdfecho*ソリューションファイルをダブルクリックして開きます。
...
5.  ドライバーの名前と、ブレークポイントを設定する関数名 ( **AddDevice**など) を使用して、ブレークポイントを**bm**コマンドで設定します。その後、感嘆符で区切ります。 **AddDevice**を使用して、読み込まれているドライバーを監視します。
    ...
    **注:**  
    &lt;モジュール&gt;のような変数を設定するときに、さまざまな構文を使用できます。&lt;シンボル&gt;、&lt;クラス&gt;::&lt;メソッド&gt;、'&lt;ファイル&gt;:&lt;行番号&gt;'、または複数回の繰り返し &lt;条件&gt; &lt;\#&gt;。 詳細については、「 [WinDbg およびその他の Windows デバッガーの条件付きブレークポイント](setting-a-conditional-breakpoint.md)」を参照してください。
...
6.  **! Process 0 0 コマンド**を使用して、関連する2つのプロセスのプロセスアドレスを検索し、これらのプロセスアドレスをここに記録します。
    ...
    EchoApp: \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_@no__t_~
