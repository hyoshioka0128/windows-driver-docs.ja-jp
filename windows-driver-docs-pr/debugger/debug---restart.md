...
をクリックして**再起動**上、**デバッグ**] メニューの [ターゲットの実行を停止し、ターゲット プロセスとそのすべてのスレッドを終了します。 このコマンドは、プロセスの開始時におけるターゲットの実行を再起動します。

このコマンドは、CTRL + SHIFT + F5 を押すか、クリックしてに相当、 **(Ctrl + Shift + F5) を再起動**ボタン (![再起動 ボタンのスクリーン ショット](images/tbrestart.png)) ツールバー。
