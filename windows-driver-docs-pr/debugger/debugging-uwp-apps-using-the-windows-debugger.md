---
title: Windows デバッガーを使用して Windows アプリのデバッグ
description: Windows デバッガー (WinDbg、CDB、NTSD) Windows アプリのデバッグに使用できます。 PLMDebug ツールを使用して、中断、再開、およびデバッグ中に Windows アプリを終了して制御します。
...
ms.locfileid: "63346320"
---
# <a name="debugging-windows-apps-using-the-windows-debugger"></a>Windows デバッガーを使用して Windows アプリのデバッグ
