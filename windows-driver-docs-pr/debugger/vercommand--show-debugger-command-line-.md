---
title: vercommand (デバッガー コマンド行の表示)
description: Vercommand コマンドでは、デバッガーを開くコマンドが表示されます。
ms.assetid: cfac4fb6-8a70-4eeb-a755-caffc6d146e3
keywords:
- vercommand (表示デバッガー コマンド行) Windows のデバッグ
ms.date: 05/23/2017
topic_type:
- apiref
api_name:
...
ms.locfileid: "56559667"
---
# <a name="vercommand-show-debugger-command-line"></a>vercommand (デバッガー コマンド行の表示)


**Vercommand**コマンドは、デバッガーを開くコマンドを表示します。
