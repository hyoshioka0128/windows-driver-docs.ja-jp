---
title: デバッグはデバッグ対象をデタッチします。
description: デバッグはデバッグ対象をデタッチします。
...
をクリックして**デバッグ対象のデタッチ**上、**デバッグ**] メニューの [ターゲット アプリケーションからのデタッチを実行したままにします。

次の条件のいずれかでは、ターゲットからのデタッチはサポートされています。

-   実行中のユーザー モード ターゲットをデバッグしています。

-   ユーザー モード ターゲット noninvasively デバッグします。
