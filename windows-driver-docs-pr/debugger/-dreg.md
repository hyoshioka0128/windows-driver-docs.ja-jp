...
省略形が使用されていない場合は、HKEY\_LOCAL\_MACHINE と見なされます。
...
**!dreg** がカーネル モードのデバッグ中に使用された場合、表示される結果は、ターゲット コンピューターではなく、ホスト コンピューターのものになります。ターゲット コンピューターの未加工のレジストリ情報を表示するには、代わりに [**!reg**](-reg.md) 拡張子を使用します。
