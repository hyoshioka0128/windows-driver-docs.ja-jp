...
[ **! Whea** ](-whea.md)と[ **! errrec** ](-errrec.md) WHEA 情報を表示する拡張機能を使用できます。 WHEA の詳細については、[Windows ハードウェア エラー アーキテクチャ (WHEA)](https://go.microsoft.com/fwlink/p/?linkid=153571) Windows Driver Kit (WDK) ドキュメントを参照してください。
