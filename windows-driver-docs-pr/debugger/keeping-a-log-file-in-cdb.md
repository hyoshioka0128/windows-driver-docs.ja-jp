---
title: CDB でのログ ファイルの保持
description: CDB でのログ ファイルの保持
...
ms.locfileid: "63367198"
---
# <a name="keeping-a-log-file-in-cdb"></a>CDB でのログ ファイルの保持


## <span id="ddk_keeping_a_log_file_dbg"></span><span id="DDK_KEEPING_A_LOG_FILE_DBG"></span>


CDB できますファイルを書き込むログを記録する、デバッグ セッション。 このログ ファイルには、すべてのコマンドを入力して、デバッガーからの応答が含まれています。
