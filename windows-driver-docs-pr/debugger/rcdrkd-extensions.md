...
カーネル モードとユーザー モード ドライバーを使用できる Windows 10 以降、[ログ トレースのように、転送トレース レコーダー (IFR)](https://msdn.microsoft.com/library/windows/hardware/dn914610)します。 カーネル モード ドライバーは、循環バッファーからメッセージを読み取る、メッセージを書式設定、およびデバッガーで、メッセージを表示する RCDRKD コマンドを使用することができます。
