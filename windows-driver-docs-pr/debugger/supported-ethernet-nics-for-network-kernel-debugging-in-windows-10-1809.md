---
title: Windows 10 バージョン 1809 (Redstone 5) ビルド17763のネットワークカーネルデバッグでサポートされるイーサネット Nic
...
ms.locfileid: "85600949"
---
# <a name="supported-ethernet-nics-for-network-kernel-debugging-in-windows10-version-1809-redstone-5-build-17763"></a>Windows 10 バージョン 1809 (Redstone 5) ビルド17763のネットワークカーネルデバッグでサポートされるイーサネット Nic
...
- Windows 10 バージョン 1809 (Redstone 5) ビルド17763
