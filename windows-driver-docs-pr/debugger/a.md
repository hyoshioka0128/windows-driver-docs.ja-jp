...
ms.locfileid: "56579651"
---
# <a name="a"></a>A


<span id="accessible"></span><span id="ACCESSIBLE"></span>**アクセス可能**  
デバッグ セッションは*アクセス*現在のターゲットが中断されている場合。

<span id="actual_processor_type"></span><span id="ACTUAL_PROCESSOR_TYPE"></span>**実際のプロセッサの種類**  
ターゲット コンピューターの物理プロセッサの種類。
