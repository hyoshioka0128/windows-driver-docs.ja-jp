...
## <a name="2-determine-the-type-kernel-mode-or-user-mode"></a>2. 種類を確認する: カーネルモードまたはユーザーモード
...
## <a name="5-choose-either-the-32-bit-or-64-bit-debugging-tools"></a>5. 32 ビットまたは64ビットのデバッグツールのいずれかを選択する
...
## <a name="7-configure-source-code"></a>7. ソースコードを構成する
...
このドキュメントでは、Windows の内部構造に関する知識を前提としています。 Windows の内部構造 (メモリ使用量、コンテキスト、スレッド、プロセスなど) の詳細については、「 [*windows の内部構造*](https://docs.microsoft.com/sysinternals/learn/windows-internals)(Mark Russinovich、David ソロモン、Alex Ionescu など)」を参照してください。

## <a name="13-review-additional-debugging-resources"></a>13. その他のデバッグリソースを確認する

その他のリソースには、次の書籍とビデオが含まれます。
-  Windows のデバッグ: Tarik Soulami による*実践的なデバッグとトレースの手法*
