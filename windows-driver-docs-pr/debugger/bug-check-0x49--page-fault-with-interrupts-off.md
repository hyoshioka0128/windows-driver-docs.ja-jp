...
description: PAGE_FAULT_WITH_INTERRUPTS_OFF のバグ チェックでは、0x00000049 の値を持ちます。このバグ チェックが非常に少ない回数が表示されます。
