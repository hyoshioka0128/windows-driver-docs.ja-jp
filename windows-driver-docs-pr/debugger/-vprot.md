...
ターゲット プロセスが所有するすべてのメモリの範囲のメモリ保護情報を表示する使用[ **! vadump**](-vadump.md)します。 メモリ保護については、次を参照してください。 *Microsoft Windows internals 』* Mark Russinovich と David Solomon します。 (この本できない場合がありますのいくつかの言語および国。)
