---
title: メモリ ダンプとページング ファイルを含む CAB ファイル
...
ms.locfileid: "56532250"
---
# <a name="cab-files-that-contain-paging-files-along-with-a-memory-dump"></a>メモリ ダンプとページング ファイルを含む CAB ファイル
