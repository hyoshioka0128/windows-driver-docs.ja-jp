...
ここで表示されます。 3 番目の引数*0x220003*、IOCTL コードに示します。 ここでは、IOCTL に関する情報を表示する IOCTL コードを使用して[ **IOCTL\_内部\_USB\_送信\_URB**](https://msdn.microsoft.com/library/windows/hardware/ff537271)します。
