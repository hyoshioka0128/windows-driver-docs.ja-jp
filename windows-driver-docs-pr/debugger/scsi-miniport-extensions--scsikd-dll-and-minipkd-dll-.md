---
title: SCSI ミニポート拡張機能 (Scsikd.dll と Minipkd.dll)
description: SCSI ミニポート拡張機能 (Scsikd.dll と Minipkd.dll)
ms.assetid: 0c22fda3-8b89-4ee4-9547-3d10f417c2e4
keywords:
- SCSI のミニポート (scsikd.dll および minipkd.dll) 拡張機能をデバッグします。
- scsikd.dll (scsi ミニポート拡張)
- minipkd.dll (scsi ミニポート拡張)
- 拡張機能、SCSI ミニポート
ms.date: 05/23/2017
...
SCSI ミニポート ドライバーのデバッグに役立つ拡張機能のコマンドは、Scsikd.dll と Minipkd.dll 記載されています。
