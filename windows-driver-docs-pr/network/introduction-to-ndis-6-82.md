...
NDIS 6.82 は、NDIS 6.81 にマイナー バージョン更新です。 NDIS 6.82 する NDIS 6.x ドライバーの移植の詳細については、[NDIS 6.82 に移植する NDIS 6.x ドライバー](porting-ndis-6-x-drivers-to-ndis-6-82.md)を参照してください。
