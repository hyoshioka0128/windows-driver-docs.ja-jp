---
title: パケット結合用の標準化された INF キーワード
description: パケット結合用の標準化された INF キーワード
...
ms.locfileid: "63390666"
---
# <a name="standardized-inf-keywords-for-packet-coalescing"></a>パケット結合用の標準化された INF キーワード
