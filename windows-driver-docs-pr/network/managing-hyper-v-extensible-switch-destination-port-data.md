...
[パケットの拡張可能スイッチの宛先ポートのデータを照会します。](querying-a-packet-s-extensible-switch-destination-port-data.md)

[拡張可能スイッチの宛先ポート データ パケットを追加します。](adding-extensible-switch-destination-port-data-to-a-packet.md)

[拡張可能スイッチの宛先ポートへのパケット配送の除外](excluding-packet-delivery-to-extensible-switch-destination-ports.md)
