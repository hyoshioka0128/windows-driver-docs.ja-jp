...
[WMI に登録されている標準のミニポート ドライバーの Oid](standard-miniport-driver-oids-registered-with-wmi.md)

[WMI に登録されている標準のミニポート ドライバーの状態インジケーター](standard-miniport-driver-status-indications-registered-with-wmi.md)
