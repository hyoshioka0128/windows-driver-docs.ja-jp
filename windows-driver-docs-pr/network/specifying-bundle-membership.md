---
title: バンドルのメンバーシップを指定します。
description: バンドルのメンバーシップを指定します。
...
ms.locfileid: "56529373"
---
# <a name="specifying-bundle-membership"></a>バンドルのメンバーシップを指定します。
