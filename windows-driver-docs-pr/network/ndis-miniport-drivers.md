...
ms.locfileid: "63378304"
---
# <a name="ndis-miniport-drivers"></a>NDIS ミニポート ドライバー





このセクションでは、NDIS ミニポート ドライバーについて説明し、次のトピックが含まれています。
...
[ネットワーク デバイスの標準化された INF キーワード](standardized-inf-keywords-for-network-devices.md)
