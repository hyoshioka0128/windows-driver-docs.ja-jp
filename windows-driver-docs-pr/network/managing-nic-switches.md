...
**注**  だけで、PF ミニポート ドライバーは、NIC スイッチなどのネットワーク アダプターのハードウェア リソースを構成できます。 ミニポート ドライバーを PCIe 仮想機能 (VF)、SR-IOV ネットワーク アダプターでは、ほとんどのアダプターのハードウェア リソースに直接アクセスできません。 詳細については、[書き込み SR-IOV VF ミニポート ドライバー](writing-sr-iov-vf-miniport-drivers.md)を参照してください。
