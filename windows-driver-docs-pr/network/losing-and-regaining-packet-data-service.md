---
title: 失われると、パケット データ サービスの復旧
description: 失われると、パケット データ サービスの復旧
...
ms.locfileid: "56531574"
---
# <a name="losing-and-regaining-packet-data-service"></a>失われると、パケット データ サービスの復旧
