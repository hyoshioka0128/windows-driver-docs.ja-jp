...
ms.date: 08/08/2017
keywords: -Windows Vista 以降の OID_SWITCH_PORT_PROPERTY_ADD ネットワークドライバー
...
Hyper-v 拡張可能スイッチのプロトコルエッジでは、オブジェクト識別子 (OID) set 要求の OID\_スイッチ\_ポート\_\_プロパティが追加され、拡張可能なスイッチ拡張機能に通知されます。拡張可能なスイッチポート。
