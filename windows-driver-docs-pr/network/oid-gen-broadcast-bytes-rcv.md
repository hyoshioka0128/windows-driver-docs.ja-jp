...
description: クエリとして OID_GEN_BROADCAST_BYTES_RCV OID がエラーのない受信ブロードキャスト パケットのバイト数を指定します。
...
クエリ、OID として\_GEN\_ブロードキャスト\_バイト\_受信 OID がエラーのない受信ブロードキャスト パケットのバイト数を指定します。
