---
title: Guid の Oid をミニポート ドライバーの状態のマッピング
description: Guid の Oid をミニポート ドライバーの状態のマッピング
...
ms.locfileid: "56550693"
---
# <a name="mapping-of-guids-to-oids-and-miniport-driver-status"></a>Guid の Oid をミニポート ドライバーの状態のマッピング
