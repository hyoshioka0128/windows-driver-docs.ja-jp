...
呼び出すことによって、デバイス オブジェクトを作成、コールアウト ドライバーは、WDM に基づいている場合、 [ **IoCreateDevice** ](https://msdn.microsoft.com/library/windows/hardware/ff548397)関数。 次に、例を示します。
