...
いる CoNDIS クライアントは、その他のプロトコル ドライバーなどを初期化しも追加いる CoNDIS エントリ ポイントを登録する必要があります。 プロトコル ドライバーの初期化の詳細については、[プロトコル ドライバーの初期化](initializing-a-protocol-driver.md)を参照してください。
