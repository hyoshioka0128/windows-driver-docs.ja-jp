...
|-----------------------------------------------------------------------|--------------------------------|----------|----------------------------------------|
| [**WDI\_TLV\_BSSID**](https://msdn.microsoft.com/library/windows/hardware/dn926153)                         |                                |          | AP の BSSID します。                   |
| [**WDI\_TLV\_FT\_AUTH\_REQUEST**](https://msdn.microsoft.com/library/windows/hardware/mt269116)   |                                |          | 認証要求のバイト blob。  |
| [**WDI\_TLV\_FT\_AUTH\_応答**](https://msdn.microsoft.com/library/windows/hardware/mt269117) |                                |          | 認証応答バイト blob。 |
