...
description: クエリとして OID_GEN_DIRECTED_FRAMES_XMIT OID にはエラーなしで送信される有向のパケットの数を指定します。
...
ms.locfileid: "56580072"
---
# <a name="oidgendirectedframesxmit"></a>OID\_GEN\_ダイレクト\_フレーム\_XMIT


クエリ、OID として\_GEN\_ダイレクト\_フレーム\_XMIT OID がエラーなしで送信される有向のパケットの数を指定します。
