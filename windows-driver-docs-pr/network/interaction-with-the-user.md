---
title: ユーザーとの対話
description: ユーザーとの対話
ms.assetid: a6235d14-5e54-42c3-8694-9129c187fbfb
keywords:
- IHV 拡張 DLL WDK ネイティブ 802.11 では、ユーザーの操作
- ユーザーの介入 WDK ネイティブ 802.11 IHV 拡張 DLL
- ネイティブ 802.11 IHV 拡張 DLL WDK、ユーザーの操作
ms.date: 04/20/2017
...
[ユーザーの介入を要求します。](requesting-user-interaction.md)

[セッションの変更の処理](processing-session-changes.md)
