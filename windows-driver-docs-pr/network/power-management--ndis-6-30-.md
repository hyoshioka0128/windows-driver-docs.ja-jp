---
title: 電源管理 (NDIS 6.30)
description: 電源管理 (NDIS 6.30)
...
このセクションでは、Windows 8 で NDIS 6.30 で導入された、電源管理インターフェイスについて説明します。

ここでは、次のトピックについて説明します。

[NDIS パケットの結合](ndis-packet-coalescing.md)

[選択的 NDIS 中断します。](ndis-selective-suspend.md)
