...
**注**  このような操作は、転送拡張機能でのみ実行できます。 この種類のドライバーの詳細については、[転送拡張機能](forwarding-extensions.md)を参照してください。
...
**注**  拡張可能スイッチ拡張機能が NDIS フィルター ドライバーをすべてに適用される NDIS 状態インジケーターをフィルター処理と同じガイドラインに従う必要があります。 詳細については、[フィルター モジュールの状態インジケーター](filter-module-status-indications.md)を参照してください。
