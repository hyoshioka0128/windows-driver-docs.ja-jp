...
-   [Winsock カーネルに TDI ドライバーの移植](porting-tdi-drivers-to-winsock-kernel.md)
-   [トランスポート アドレスを共有](sharing-transport-addresses.md)
-   [TDI トランスポートを使用します。](using-tdi-transports.md)
-   [NMR を使用して、WSK の登録と登録解除](using-nmr-for-wsk-registration-and-unregistration.md)
