...
NDPROXY は、ミニポート ドライバーの TAPI 機能を列挙し、後で NDIS 構造にカプセル化される TAPI 要求を送信できます。 TAPI サポートいる CoNDIS 拡張機能の使用に関する詳細については、[いる CoNDIS WAN 操作をサポート電話サービス](condis-wan-operations-that-support-telephonic-services.md)を参照してください。
