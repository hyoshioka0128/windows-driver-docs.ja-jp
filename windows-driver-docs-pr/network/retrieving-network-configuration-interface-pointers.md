---
title: ネットワーク構成のインターフェイス ポインターを取得します。
description: ネットワーク構成のインターフェイス ポインターを取得します。
...
ms.locfileid: "56551779"
---
# <a name="retrieving-network-configuration-interface-pointers"></a>ネットワーク構成のインターフェイス ポインターを取得します。
