---
title: NDIS QoS の標準化された INF キーワード
description: NDIS QoS の標準化された INF キーワード
...
ms.locfileid: "56531389"
---
# <a name="standardized-inf-keywords-for-ndis-qos"></a>NDIS QoS の標準化された INF キーワード
