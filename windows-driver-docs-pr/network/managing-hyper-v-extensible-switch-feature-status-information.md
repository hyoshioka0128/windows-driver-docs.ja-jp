---
title: Hyper-V 拡張可能スイッチ機能の状態情報の管理
description: Hyper-V 拡張可能スイッチ機能の状態情報の管理
...
HYPER-V 拡張可能スイッチのインターフェイスには、拡張可能スイッチまたはポートの 1 つのカスタム状態情報を取得する機能がサポートしています。 この状態情報は、機能の状態情報と呼ばれます。

ここでは、次のトピックについて説明します。

[カスタム ポート機能の状態情報を管理します。](managing-custom-port-feature-status-information.md)
