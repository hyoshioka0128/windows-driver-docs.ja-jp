---
title: Hyper-V 拡張可能スイッチ拡張機能
description: Hyper-V 拡張可能スイッチ拡張機能
...
このセクションでは、拡張可能スイッチのインターフェイスでサポートされている NDIS フィルター ドライバーの種類について説明します。 これらのフィルター ドライバーと呼ばれる*拡張可能スイッチの拡張機能*します。

ここでは、次のトピックについて説明します。

[キャプチャ拡張機能](capturing-extensions.md)

[フィルター拡張機能](filtering-extensions.md)
