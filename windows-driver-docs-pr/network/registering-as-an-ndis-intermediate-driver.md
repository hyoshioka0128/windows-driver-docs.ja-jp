---
title: NDIS 中間ドライバーとして登録します。
description: NDIS 中間ドライバーとして登録します。
...
ms.locfileid: "56550734"
---
# <a name="registering-as-an-ndis-intermediate-driver"></a>NDIS 中間ドライバーとして登録します。
