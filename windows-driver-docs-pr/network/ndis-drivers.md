...
>[!NOTE]
> これらのトピックでは、NDIS ドライバーの各種類は個別にについて詳しく説明します。 NDIS ドライバー スタックと 4 つすべての NDIS ドライバーの種類間のリレーションシップを示す図の詳細については、[NDIS ドライバー スタック](ndis-driver-stack.md)を参照してください。