...
description: クエリとして OID_GEN_MULTICAST_BYTES_RCV OID マルチキャスト機能/パケットのエラーのない受信したバイト数を指定します。
ms.assetid: 9c360aeb-f9b0-41d2-a6e0-feacd5419f55
ms.date: 08/08/2017
keywords: -OID_GEN_MULTICAST_BYTES_RCV ネットワーク ドライバーが Windows Vista 以降
...
ms.locfileid: "63348104"
---
# <a name="oidgenmulticastbytesrcv"></a>OID\_GEN\_マルチキャスト\_バイト\_受信


クエリ、OID として\_GEN\_マルチキャスト\_バイト\_受信 OID マルチキャスト機能/パケットのエラーのない受信したバイト数を指定します。
