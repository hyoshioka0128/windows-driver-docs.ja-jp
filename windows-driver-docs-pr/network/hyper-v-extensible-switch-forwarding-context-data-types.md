---
title: HYPER-V 拡張可能スイッチのコンテキストのデータ型の転送
description: HYPER-V 拡張可能スイッチのコンテキストのデータ型の転送
...
ms.locfileid: "56529837"
---
# <a name="hyper-v-extensible-switch-forwarding-context-data-types"></a>HYPER-V 拡張可能スイッチのコンテキストのデータ型の転送
