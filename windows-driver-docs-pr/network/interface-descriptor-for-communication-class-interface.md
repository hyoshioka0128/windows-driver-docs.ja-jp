---
title: 通信クラス インターフェイスのインターフェイス記述子
description: 通信クラス インターフェイスのインターフェイス記述子
...
---
# <a name="interface-descriptor-for-communication-class-interface"></a>通信クラス インターフェイスのインターフェイス記述子
