...
|-----------------------------------------------------------------------------------------------------------------|--------------------------------|----------|-------------------------------------------------|
| [**WDI\_TLV\_送信\_アクション\_フレーム\_要求\_パラメーター**](https://docs.microsoft.com/windows-hardware/drivers/network/wdi-tlv-send-action-frame-request-parameters) |                                |          | アクションのフレーム要求を送信するためのパラメーターです。 |
