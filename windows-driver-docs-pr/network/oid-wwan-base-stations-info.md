...
OID_WWAN_BASE_STATIONS_INFO には、サービスを提供し、隣接するセルの既知のモデムに関する情報を取得します。 携帯電話の基地局情報のクエリに関する詳細については、[MB ベース ステーションはクエリのサポート](mb-base-stations-information-query-support.md)を参照してください。
