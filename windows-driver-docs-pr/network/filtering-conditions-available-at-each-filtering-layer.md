---
title: 各フィルター レイヤーで使用可能なフィルター条件
...
ms.locfileid: "63347389"
---
# <a name="filtering-conditions-available-at-each-filtering-layer"></a>各フィルター レイヤーで使用可能なフィルター条件
...
<p>FWPM_CONDITION_SUB_INTERFACE_INDEX <p><b>注</b>  Windows Vista では、このフラグは FWPM_CONDITION_ARRIVAL_SUB_INTERFACE_INDEX で呼び出されました。 Windows Vista Service Pack 1 (SP1) 以降では、両方の名前は有効です。</p>
</p>
<p>FWPM_CONDITION_ARRIVAL_TUNNEL_TYPE</p>
<p>FWPM_CONDITION_INTERFACE_INDEX <p><b>注</b>  Windows Vista では、このフラグは FWPM_CONDITION_LOCAL_INTERFACE_INDEX で呼び出されました。 Windows Vista SP1 以降では、両方の名前は有効です。</p>
</p>
<p>FWPM_CONDITION_INTERFACE_TYPE <p><b>注</b>  Windows Vista では、このフラグは FWPM_CONDITION_LOCAL_INTERFACE_TYPE で呼び出されました。 Windows Vista SP1 以降では、両方の名前は有効です。</p>
</p>
<p>FWPM_CONDITION_TUNNEL_TYPE <p><b>注</b>  Windows Vista では、このフラグは FWPM_CONDITION_LOCAL_TUNNEL_TYPE で呼び出されました。 Windows Vista SP1 以降では、両方の名前は有効です。</p>
</p>
</td>
</tr>
<tr>
...
<p>FWPM_CONDITION_ARRIVAL_INTERFACE_INDEX</p>
<p>FWPM_CONDITION_ARRIVAL_INTERFACE_TYPE</p>
<p>FWPM_CONDITION_SUB_INTERFACE_INDEX <p><b>注</b>  Windows Vista では、このフラグは FWPM_CONDITION_ARRIVAL_SUB_INTERFACE_INDEX で呼び出されました。 Windows Vista SP1 以降では、両方の名前は有効です。</p>
</p>
<p>FWPM_CONDITION_ARRIVAL_TUNNEL_TYPE</p>
<p>FWPM_CONDITION_INTERFACE_INDEX <p><b>注</b>  Windows Vista では、このフラグは FWPM_CONDITION_LOCAL_INTERFACE_INDEX で呼び出されました。 Windows Vista SP1 以降では、両方の名前は有効です。</p>
</p>
