...
description: ポートの NDIS 6.20 が動作するためのプロトコル ドライバーに必要な変更の概要
...
ms.locfileid: "56539097"
---
# <a name="summary-of-changes-required-to-port-a-protocol-driver-to-ndis-620"></a>ポートの NDIS 6.20 が動作するためのプロトコル ドライバーに必要な変更の概要
