---
title: ドライバーに WDI TLV ジェネレーター/パーサーを追加します。
...
ms.locfileid: "56553737"
---
# <a name="adding-the-wdi-tlv-generatorparser-to-your-driver"></a>ドライバーに WDI TLV ジェネレーター/パーサーを追加します。
