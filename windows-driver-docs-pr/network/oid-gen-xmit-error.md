...
description: クエリとして OID_GEN_XMIT_ERROR OID には、NIC が送信に失敗するフレームの数を指定します。
ms.assetid: c4f42271-812b-4da9-8280-79d3bddc5164
ms.date: 08/08/2017
keywords: -OID_GEN_XMIT_ERROR ネットワーク ドライバーが Windows Vista 以降
...
ms.locfileid: "56537905"
---
# <a name="oidgenxmiterror"></a>OID\_GEN\_XMIT\_エラー


クエリ、OID として\_GEN\_XMIT\_エラー OID が NIC は、送信に失敗するフレームの数を指定します。
