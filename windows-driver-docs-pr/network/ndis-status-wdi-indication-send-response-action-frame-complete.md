...
description: ミニポート ドライバーでは、NDIS_STATUS_WDI_INDICATION_SEND_RESPONSE_ACTION_FRAME_COMPLETE を使用して、OID_WDI_TASK_SEND_RESPONSE_ACTION_FRAME の完了を示します。
...
ミニポート ドライバーを使用して、NDIS\_状態\_WDI\_INDICATION\_送信\_応答\_アクション\_フレーム\_の完了を示すために完了[OID\_WDI\_タスク\_送信\_応答\_アクション\_フレーム](oid-wdi-task-send-response-action-frame.md)します。
