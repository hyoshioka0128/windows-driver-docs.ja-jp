...
description: クエリとして OID_GEN_DIRECTED_FRAMES_RCV OID にはエラーなしで受信された有向のパケットの数を指定します。
ms.assetid: 6f8b84d3-19d6-4a2a-a2eb-8961614fbba4
ms.date: 08/08/2017
keywords: -OID_GEN_DIRECTED_FRAMES_RCV ネットワーク ドライバーが Windows Vista 以降
...
ms.locfileid: "67369127"
---
# <a name="oidgendirectedframesrcv"></a>OID\_GEN\_ダイレクト\_フレーム\_受信


クエリ、OID として\_GEN\_ダイレクト\_フレーム\_受信 OID がエラーなしで受信された有向のパケットの数を指定します。
