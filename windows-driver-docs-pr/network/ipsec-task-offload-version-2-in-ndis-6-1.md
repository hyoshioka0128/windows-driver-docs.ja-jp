---
title: IPsec タスク オフロード バージョン 2 で NDIS 6.1
description: IPsec タスク オフロード バージョン 2 で NDIS 6.1
...
ms.locfileid: "56531375"
---
# <a name="ipsec-task-offload-version-2-in-ndis-61"></a>IPsec タスク オフロード バージョン 2 で NDIS 6.1
