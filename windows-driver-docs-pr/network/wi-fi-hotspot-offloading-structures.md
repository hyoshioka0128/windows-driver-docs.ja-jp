---
title: Wi-fi ホット スポットの構造体のオフロード
description: Wi-fi ホット スポットの構造体のオフロード
...
ms.locfileid: "56557896"
---
# <a name="wi-fi-hotspot-offloading-structures"></a>Wi-fi ホット スポットの構造体のオフロード
