...
ms.locfileid: "56580001"
---
# <a name="showdeviceindisconnectedstate"></a>ShowDeviceInDisconnectedState

[!include[MBAE deprecation warning](mbae-deprecation-warning.md)]

ShowDeviceInDisconnectedState 要素に設定する必要があります**false**のため、Windows 8、Windows 8.1、および Windows 10 でのサービス メタデータ パッケージには適用されません。
...
設定する必要があります**false**のため、Windows 8、Windows 8.1、および Windows 10 でのサービス メタデータ パッケージには適用されません。
...
ShowDeviceInDisconnectedState 要素が必要です。
