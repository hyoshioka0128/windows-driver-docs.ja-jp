...
サービス メタデータ パッケージには、モバイル ブロード バンド ネットワークに固有の情報を含む 1 つの MobileBroadbandInfo.xml ドキュメントが含まれています。

文書の書式設定 MobileBroadbandInfo.xml 内のデータは、このセクションで説明されている MobileBroadbandInfo XML スキーマに基づいています。
