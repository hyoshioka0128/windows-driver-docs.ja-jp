---
title: モバイル ブロード バンドの Windows ランタイム Api の概要
description: モバイル ブロード バンドの Windows ランタイム Api の概要
...
ms.locfileid: "67608543"
---
# <a name="overview-of-mobile-broadband-windows-runtime-apis"></a>モバイル ブロード バンドの Windows ランタイム Api の概要
