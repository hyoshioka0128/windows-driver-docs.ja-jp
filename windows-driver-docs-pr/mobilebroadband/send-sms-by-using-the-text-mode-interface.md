...
-   [文字およびドラフト SMS のセグメントを計算します。](calculate-characters-and-segments-of-a-draft-sms.md)

-   [携帯電話番号を指定します。](specify-mobile-telephone-numbers.md)

-   [Windows が自動的に時間の長いメッセージをセグメントします。](windows-automatically-segments-long-messages.md)

-   [Windows が自動的に最適な文字エンコーディングを選択します](windows-automatically-selects-optimal-character-encoding.md)
