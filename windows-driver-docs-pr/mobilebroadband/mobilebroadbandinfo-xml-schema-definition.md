---
title: MobileBroadbandInfo XML スキーマの定義
description: MobileBroadbandInfo XML スキーマの定義
...
ms.locfileid: "72323669"
---
# <a name="mobilebroadbandinfo-xml-schema-definition"></a>MobileBroadbandInfo XML スキーマの定義

[!include[MBAE deprecation warning](mbae-deprecation-warning.md)]

MobileBroadbandInfo XML スキーマの名前空間を次に示します。

``` syntax
http://schemas.microsoft.com/windows/2010/12/DeviceMetadata/MobileBroadbandInfo
```

MobileBroadbandInfo スキーマの定義を次に示します。
