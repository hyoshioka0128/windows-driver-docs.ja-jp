...
ms.locfileid: "72323713"
---
# <a name="launchdevicestageondeviceconnect"></a>LaunchDeviceStageOnDeviceConnect

[!include[MBAE deprecation warning](mbae-deprecation-warning.md)]

LaunchDeviceStageOnDeviceConnect 要素は、Windows 8、Windows 8.1、および Windows 10 のサービスメタデータパッケージには適用されないので、 **false**に設定する必要があります。
...
Windows 8、Windows 8.1、および Windows 10 のサービスメタデータパッケージには適用されないので、 **false**に設定する必要があります。
...
LaunchDeviceStageOnDeviceConnect 要素は省略可能です。
