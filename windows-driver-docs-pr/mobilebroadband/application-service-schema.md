...
ms.locfileid: "72323644"
---
# <a name="application"></a>アプリケーション

[!include[MBAE deprecation warning](mbae-deprecation-warning.md)]

Application 要素は、デバイスメタデータパッケージを作成したアプリケーションソフトウェアの名前を指定します。
...
Application 要素は、Windows 7 オペレーティングシステムでは使用されません。 Oem および開発者が使用するために予約されています。
